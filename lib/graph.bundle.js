(() => {
  ...
  var require_react_production_min = __commonJS({
    "node_modules/react/cjs/react.production.min.js"(exports) {
      ...
      function M(a3, b2, e2) {
        ...
        if (null != b2) for (d2 in void 0 !== b2.ref && (h2 = b2.ref), void 0 !== b2.key && (k2 = "" + b2.key), b2) J2.call(b2, d2) && !L2.hasOwnProperty(d2) && (c3[d2] = b2[d2]);
        var g2 = arguments.length - 2;
        if (1 === g2) c3.children = e2;
        else if (1 < g2) {
          for (var f2 = Array(g2), m3 = 0; m3 < g2; m3++) f2[m3] = arguments[m3 + 2];
          c3.children = f2;
        }
        if (a3 && a3.defaultProps) for (d2 in g2 = a3.defaultProps, g2) void 0 === c3[d2] && (c3[d2] = g2[d2]);
        return { $$typeof: l2, type: a3, key: k2, ref: h2, props: c3, _owner: K2.current };
      }
      function N2(a3, b2) {
      ...
      function R2(a3, b2, e2, d2, c3) {
        ...
        if (h2) return h2 = a3, c3 = c3(h2), a3 = "" === d2 ? "." + Q2(h2, 0) : d2, I2(c3) ? (e2 = "", null != a3 && (e2 = a3.replace(P2, "$&/") + "/"), R2(c3, b2, e2, "", function(a4) {
          return a4;
        })) : null != c3 && (O2(c3) && (c3 = N2(c3, e2 + (!c3.key || h2 && h2.key === c3.key ? "" : ("" + c3.key).replace(P2, "$&/") + "/") + a3)), b2.push(c3)), 1;
        h2 = 0;
        d2 = "" === d2 ? "." : d2 + ":";
        ...
        else if (f2 = A2(a3), "function" === typeof f2) for (a3 = f2.call(a3), g2 = 0; !(k2 = a3.next()).done; ) k2 = k2.value, f2 = d2 + Q2(k2, g2++), h2 += R2(k2, b2, e2, f2, c3);
      ...
      function S2(a3, b2, e2) {
        ...
        var d2 = [], c3 = 0;
        R2(a3, d2, "", "", function(a4) {
          return b2.call(e2, a4, c3++);
        });
        return d2;
      }
      function T2(a3) {
      ...
      var W2 = { ReactCurrentDispatcher: U, ReactCurrentBatchConfig: V2, ReactCurrentOwner: K2 };
      function X() {
        throw Error("act(...) is not supported in production builds of React.");
      }
      exports.Children = { map: S2, forEach: function(a3, b2, e2) {
        S2(a3, function() {
      ...
      exports.cloneElement = function(a3, b2, e2) {
        ...
        return { $$typeof: l2, type: a3.type, key: c3, ref: k2, props: d2, _owner: h2 };
      };
      ...
      exports.memo = function(a3, b2) {
        return { $$typeof: x3, type: a3, compare: void 0 === b2 ? null : b2 };
      };
      ...
      exports.useCallback = function(a3, b2) {
        return U.current.useCallback(a3, b2);
      };
      ...
      exports.useEffect = function(a3, b2) {
        return U.current.useEffect(a3, b2);
      };
      exports.useId = function() {
        return U.current.useId();
      };
      exports.useImperativeHandle = function(a3, b2, e2) {
        return U.current.useImperativeHandle(a3, b2, e2);
      };
      exports.useInsertionEffect = function(a3, b2) {
        return U.current.useInsertionEffect(a3, b2);
      };
      exports.useLayoutEffect = function(a3, b2) {
        return U.current.useLayoutEffect(a3, b2);
      };
      exports.useMemo = function(a3, b2) {
        return U.current.useMemo(a3, b2);
      };
      exports.useReducer = function(a3, b2, e2) {
        return U.current.useReducer(a3, b2, e2);
      };
      ...
      exports.useSyncExternalStore = function(a3, b2, e2) {
        return U.current.useSyncExternalStore(a3, b2, e2);
      };
  ...
  var require_scheduler_production_min = __commonJS({
    "node_modules/scheduler/cjs/scheduler.production.min.js"(exports) {
      ...
      function f2(a3, b2) {
        ...
        a3.push(b2);
        a: for (; 0 < c3; ) {
          var d2 = c3 - 1 >>> 1, e2 = a3[d2];
          if (0 < g2(e2, b2)) a3[d2] = b2, a3[c3] = e2, c3 = d2;
          else break a;
        }
      }
      function h2(a3) {
      ...
      function k2(a3) {
        ...
        var b2 = a3[0], c3 = a3.pop();
        if (c3 !== b2) {
          a3[0] = c3;
          a: for (var d2 = 0, e2 = a3.length, w2 = e2 >>> 1; d2 < w2; ) {
            var m3 = 2 * (d2 + 1) - 1, C2 = a3[m3], n2 = m3 + 1, x3 = a3[n2];
            if (0 > g2(C2, c3)) n2 < e2 && 0 > g2(x3, C2) ? (a3[d2] = x3, a3[n2] = c3, d2 = n2) : (a3[d2] = C2, a3[m3] = c3, d2 = m3);
            else if (n2 < e2 && 0 > g2(x3, c3)) a3[d2] = x3, a3[n2] = c3, d2 = n2;
            else break a;
          }
        }
        return b2;
      ...
      function g2(a3, b2) {
        var c3 = a3.sortIndex - b2.sortIndex;
        return 0 !== c3 ? c3 : a3.id - b2.id;
      }
      ...
      function G2(a3) {
        for (var b2 = h2(t3); null !== b2; ) {
          ...
          else if (b2.startTime <= a3) k2(t3), b2.sortIndex = b2.expirationTime, f2(r2, b2);
          else break;
          b2 = h2(t3);
        }
      }
      ...
      function J2(a3, b2) {
        ...
        try {
          G2(b2);
          for (v2 = h2(r2); null !== v2 && (!(v2.expirationTime > b2) || a3 && !M()); ) {
            var d2 = v2.callback;
      ...
      exports.unstable_scheduleCallback = function(a3, b2, c3) {
        ...
        e2 = c3 + e2;
        a3 = { id: u2++, callback: b2, priorityLevel: a3, startTime: c3, expirationTime: e2, sortIndex: -1 };
        c3 > d2 ? (a3.sortIndex = c3, f2(t3, a3), null === h2(r2) && a3 === h2(t3) && (B2 ? (E2(L2), L2 = -1) : B2 = true, K2(H2, c3 - d2))) : (a3.sortIndex = e2, f2(r2, a3), A2 || z3 || (A2 = true, I2(J2)));
        return a3;
      };
  ...
  var require_react_dom_production_min = __commonJS({
    "node_modules/react-dom/cjs/react-dom.production.min.js"(exports) {
      ...
      function p2(a3) {
        for (var b2 = "https://reactjs.org/docs/error-decoder.html?invariant=" + a3, c3 = 1; c3 < arguments.length; c3++) b2 += "&args[]=" + encodeURIComponent(arguments[c3]);
      ...
      function qa(a3, b2, c3, d2) {
        if (null === b2 || "undefined" === typeof b2 || pa(a3, b2, c3, d2)) return true;
        if (d2) return false;
      ...
      function v2(a3, b2, c3, d2, e2, f2, g2) {
      ...
      [["acceptCharset", "accept-charset"], ["className", "class"], ["htmlFor", "for"], ["httpEquiv", "http-equiv"]].forEach(function(a3) {
        var b2 = a3[0];
        z3[b2] = new v2(b2, 1, false, a3[1], null, false, false);
      });
      ...
      "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(a3) {
        ...
        z3[b2] = new v2(b2, 1, false, a3, null, false, false);
      });
      "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(a3) {
        ...
        z3[b2] = new v2(b2, 1, false, a3, "http://www.w3.org/1999/xlink", false, false);
      });
      ["xml:base", "xml:lang", "xml:space"].forEach(function(a3) {
        var b2 = a3.replace(ra, sa);
        z3[b2] = new v2(b2, 1, false, a3, "http://www.w3.org/XML/1998/namespace", false, false);
      });
      ...
      function ta(a3, b2, c3, d2) {
        var e2 = z3.hasOwnProperty(b2) ? z3[b2] : null;
        if (null !== e2 ? 0 !== e2.type : d2 || !(2 < b2.length) || "o" !== b2[0] && "O" !== b2[0] || "n" !== b2[1] && "N" !== b2[1]) qa(b2, c3, e2, d2) && (c3 = null), d2 || null === e2 ? oa(b2) && (null === c3 ? a3.removeAttribute(b2) : a3.setAttribute(b2, "" + c3)) : e2.mustUseProperty ? a3[e2.propertyName] = null === c3 ? 3 === e2.type ? false : "" : c3 : (b2 = e2.attributeName, d2 = e2.attributeNamespace, null === c3 ? a3.removeAttribute(b2) : (e2 = e2.type, c3 = 3 === e2 || 4 === e2 && true === c3 ? "" : "" + c3, d2 ? a3.setAttributeNS(d2, b2, c3) : a3.setAttribute(b2, c3)));
      }
      ...
      function Ua(a3) {
        var b2 = Ta(a3) ? "checked" : "value", c3 = Object.getOwnPropertyDescriptor(a3.constructor.prototype, b2), d2 = "" + a3[b2];
        if (!a3.hasOwnProperty(b2) && "undefined" !== typeof c3 && "function" === typeof c3.get && "function" === typeof c3.set) {
          ...
          Object.defineProperty(a3, b2, { enumerable: c3.enumerable });
      ...
      function Wa(a3) {
        ...
        a3 = d2;
        return a3 !== c3 ? (b2.setValue(a3), true) : false;
      }
      function Xa(a3) {
      ...
      function Ya(a3, b2) {
        var c3 = b2.checked;
        return A2({}, b2, { defaultChecked: void 0, defaultValue: void 0, value: void 0, checked: null != c3 ? c3 : a3._wrapperState.initialChecked });
      }
      function Za(a3, b2) {
        ...
        a3._wrapperState = { initialChecked: d2, initialValue: c3, controlled: "checkbox" === b2.type || "radio" === b2.type ? null != b2.checked : null != b2.value };
      }
      function ab(a3, b2) {
        b2 = b2.checked;
      ...
      function bb(a3, b2) {
        ...
        b2.hasOwnProperty("value") ? cb(a3, b2.type, c3) : b2.hasOwnProperty("defaultValue") && cb(a3, b2.type, Sa(b2.defaultValue));
      ...
      function cb(a3, b2, c3) {
        if ("number" !== b2 || Xa(a3.ownerDocument) !== a3) null == c3 ? a3.defaultValue = "" + a3._wrapperState.initialValue : a3.defaultValue !== "" + c3 && (a3.defaultValue = "" + c3);
      }
      var eb = Array.isArray;
      function fb(a3, b2, c3, d2) {
        a3 = a3.options;
        if (b2) {
          b2 = {};
          for (var e2 = 0; e2 < c3.length; e2++) b2["$" + c3[e2]] = true;
          for (c3 = 0; c3 < a3.length; c3++) e2 = b2.hasOwnProperty("$" + a3[c3].value), a3[c3].selected !== e2 && (a3[c3].selected = e2), e2 && d2 && (a3[c3].defaultSelected = true);
        } else {
          c3 = "" + Sa(c3);
          b2 = null;
      ...
      function hb(a3, b2) {
        ...
        if (null == c3) {
          ...
          if (null != c3) {
            ...
            if (eb(c3)) {
              if (1 < c3.length) throw Error(p2(93));
              c3 = c3[0];
            }
            b2 = c3;
          }
      ...
      function ib(a3, b2) {
        ...
        null != c3 && (c3 = "" + c3, c3 !== a3.value && (a3.value = c3), null == b2.defaultValue && a3.defaultValue !== c3 && (a3.defaultValue = c3));
      ...
      function rb(a3, b2, c3) {
        return null == b2 || "boolean" === typeof b2 || "" === b2 ? "" : c3 || "number" !== typeof b2 || 0 === b2 || pb.hasOwnProperty(a3) && pb[a3] ? ("" + b2).trim() : b2 + "px";
      }
      function sb(a3, b2) {
        a3 = a3.style;
        for (var c3 in b2) if (b2.hasOwnProperty(c3)) {
          ...
          d2 ? a3.setProperty(c3, e2) : a3[c3] = e2;
        }
      }
      ...
      var Ib = false;
      function Jb(a3, b2, c3) {
        if (Ib) return a3(b2, c3);
        Ib = true;
        try {
          return Gb(a3, b2, c3);
        } finally {
      ...
      function Kb(a3, b2) {
        ...
        if (a3) return null;
        if (c3 && "function" !== typeof c3) throw Error(p2(231, b2, typeof c3));
        return c3;
      }
      var Lb = false;
      if (ia) try {
      ...
      var Mb;
      function Nb(a3, b2, c3, d2, e2, f2, g2, h2, k2) {
      ...
      function Tb(a3, b2, c3, d2, e2, f2, g2, h2, k2) {
        Ob = false;
        Pb = null;
        Nb.apply(Sb, arguments);
      }
      function Ub(a3, b2, c3, d2, e2, f2, g2, h2, k2) {
      ...
      function Vb(a3) {
        ...
        if (a3.alternate) for (; b2.return; ) b2 = b2.return;
          ...
          a3 = b2;
          do
            b2 = a3, 0 !== (b2.flags & 4098) && (c3 = b2.return), a3 = b2.return;
          while (a3);
        }
      ...
      function Yb(a3) {
        ...
        for (var c3 = a3, d2 = b2; ; ) {
          ...
          if (e2.child === f2.child) {
            for (f2 = e2.child; f2; ) {
              if (f2 === c3) return Xb(e2), a3;
              if (f2 === d2) return Xb(e2), b2;
              f2 = f2.sibling;
            }
            throw Error(p2(188));
          }
          if (c3.return !== d2.return) c3 = e2, d2 = f2;
          else {
          ...
          if (c3.alternate !== d2) throw Error(p2(190));
        }
        if (3 !== c3.tag) throw Error(p2(188));
        return c3.stateNode.current === c3 ? a3 : b2;
      }
      function Zb(a3) {
        a3 = Yb(a3);
      ...
      function uc(a3, b2) {
        ...
        if (0 === c3) return 0;
        var d2 = 0, e2 = a3.suspendedLanes, f2 = a3.pingedLanes, g2 = c3 & 268435455;
        if (0 !== g2) {
          var h2 = g2 & ~e2;
          0 !== h2 ? d2 = tc(h2) : (f2 &= g2, 0 !== f2 && (d2 = tc(f2)));
        } else g2 = c3 & ~e2, 0 !== g2 ? d2 = tc(g2) : 0 !== f2 && (d2 = tc(f2));
        if (0 === d2) return 0;
        if (0 !== b2 && b2 !== d2 && 0 === (b2 & e2) && (e2 = d2 & -d2, f2 = b2 & -b2, e2 >= f2 || 16 === e2 && 0 !== (f2 & 4194240))) return b2;
        0 !== (d2 & 4) && (d2 |= c3 & 16);
        b2 = a3.entangledLanes;
        if (0 !== b2) for (a3 = a3.entanglements, b2 &= d2; 0 < b2; ) c3 = 31 - oc(b2), e2 = 1 << c3, d2 |= a3[c3], b2 &= ~e2;
        return d2;
      }
      function vc(a3, b2) {
        switch (a3) {
      ...
      function wc(a3, b2) {
        for (var c3 = a3.suspendedLanes, d2 = a3.pingedLanes, e2 = a3.expirationTimes, f2 = a3.pendingLanes; 0 < f2; ) {
          var g2 = 31 - oc(f2), h2 = 1 << g2, k2 = e2[g2];
          if (-1 === k2) {
            if (0 === (h2 & c3) || 0 !== (h2 & d2)) e2[g2] = vc(h2, b2);
      ...
      function zc(a3) {
        for (var b2 = [], c3 = 0; 31 > c3; c3++) b2.push(a3);
        return b2;
      }
      function Ac(a3, b2, c3) {
        a3.pendingLanes |= b2;
      ...
      function Tc(a3, b2, c3, d2, e2, f2) {
        if (null === a3 || a3.nativeEvent !== f2) return a3 = { blockedOn: b2, domEventName: c3, eventSystemFlags: d2, nativeEvent: f2, targetContainers: [e2] }, null !== b2 && (b2 = Cb(b2), null !== b2 && Fc(b2)), a3;
        a3.eventSystemFlags |= d2;
        b2 = a3.targetContainers;
        null !== e2 && -1 === b2.indexOf(e2) && b2.push(e2);
        return a3;
      }
      function Uc(a3, b2, c3, d2, e2) {
        switch (b2) {
          case "focusin":
            return Lc = Tc(Lc, a3, b2, c3, d2, e2), true;
          case "dragenter":
            return Mc = Tc(Mc, a3, b2, c3, d2, e2), true;
          case "mouseover":
            return Nc = Tc(Nc, a3, b2, c3, d2, e2), true;
          case "pointerover":
            var f2 = e2.pointerId;
            Oc.set(f2, Tc(Oc.get(f2) || null, a3, b2, c3, d2, e2));
            return true;
          case "gotpointercapture":
            return f2 = e2.pointerId, Pc.set(f2, Tc(Pc.get(f2) || null, a3, b2, c3, d2, e2)), true;
        }
        return false;
      }
      function Vc(a3) {
      ...
      function Xc(a3) {
        ...
        for (var b2 = a3.targetContainers; 0 < b2.length; ) {
          var c3 = Yc(a3.domEventName, a3.eventSystemFlags, b2[0], a3.nativeEvent);
          if (null === c3) {
            c3 = a3.nativeEvent;
            ...
            wb = null;
          } else return b2 = Cb(c3), null !== b2 && Fc(b2), a3.blockedOn = c3, false;
          b2.shift();
        }
        return true;
      }
      function Zc(a3, b2, c3) {
        Xc(a3) && c3.delete(b2);
      }
      function $c() {
        Jc = false;
      ...
      function bd(a3) {
        ...
        Oc.forEach(b2);
        Pc.forEach(b2);
        for (c3 = 0; c3 < Qc.length; c3++) d2 = Qc[c3], d2.blockedOn === a3 && (d2.blockedOn = null);
        for (; 0 < Qc.length && (c3 = Qc[0], null === c3.blockedOn); ) Vc(c3), null === c3.blockedOn && Qc.shift();
      }
      var cd = ua.ReactCurrentBatchConfig;
      var dd = true;
      function ed(a3, b2, c3, d2) {
      ...
      function fd(a3, b2, c3, d2) {
        if (dd) {
          var e2 = Yc(a3, b2, c3, d2);
          if (null === e2) hd(a3, b2, d2, id2, c3), Sc(a3, d2);
          else if (Uc(e2, a3, b2, c3, d2)) d2.stopPropagation();
          else if (Sc(a3, d2), b2 & 4 && -1 < Rc.indexOf(a3)) {
            for (; null !== e2; ) {
              var f2 = Cb(e2);
              null !== f2 && Ec(f2);
              f2 = Yc(a3, b2, c3, d2);
              null === f2 && hd(a3, b2, d2, id2, c3);
              if (f2 === e2) break;
              e2 = f2;
            }
            null !== e2 && d2.stopPropagation();
          } else hd(a3, b2, d2, null, c3);
        }
      }
      var id2 = null;
      function Yc(a3, b2, c3, d2) {
        id2 = null;
        a3 = xb(d2);
        a3 = Wc(a3);
      ...
      function nd() {
        if (md) return md;
        var a3, b2 = ld, c3 = b2.length, d2, e2 = "value" in kd ? kd.value : kd.textContent, f2 = e2.length;
        for (a3 = 0; a3 < c3 && b2[a3] === e2[a3]; a3++) ;
        var g2 = c3 - a3;
      ...
      function rd(a3) {
        function b2(b3, d2, e2, f2, g2) {
          ...
          for (var c3 in a3) a3.hasOwnProperty(c3) && (b3 = a3[c3], this[c3] = b3 ? b3(f2) : f2[c3]);
      ...
      function ne(a3, b2, c3, d2) {
        Eb(d2);
        b2 = oe(b2, "onChange");
        0 < b2.length && (c3 = new td("onChange", "change", null, c3, d2), a3.push({ event: c3, listeners: b2 }));
      }
      var pe = null;
      var qe = null;
      function re(a3) {
      ...
      function Ce(a3, b2, c3) {
        "focusin" === a3 ? (Ae(), pe = b2, qe = c3, pe.attachEvent("onpropertychange", Be)) : "focusout" === a3 && Ae();
      }
      function De(a3) {
      ...
      function Ie(a3, b2) {
        ...
        var c3 = Object.keys(a3), d2 = Object.keys(b2);
        if (c3.length !== d2.length) return false;
        for (d2 = 0; d2 < c3.length; d2++) {
          var e2 = c3[d2];
          if (!ja.call(b2, e2) || !He(a3[e2], b2[e2])) return false;
        }
        return true;
      }
      function Je(a3) {
      ...
      function Ke(a3, b2) {
        ...
        for (var d2; c3; ) {
          if (3 === c3.nodeType) {
            d2 = a3 + c3.textContent.length;
            if (a3 <= b2 && d2 >= b2) return { node: c3, offset: b2 - a3 };
            a3 = d2;
          }
          a: {
            for (; c3; ) {
      ...
      function Oe(a3) {
        var b2 = Me(), c3 = a3.focusedElem, d2 = a3.selectionRange;
        if (b2 !== c3 && c3 && c3.ownerDocument && Le(c3.ownerDocument.documentElement, c3)) {
          if (null !== d2 && Ne(c3)) {
            if (b2 = d2.start, a3 = d2.end, void 0 === a3 && (a3 = b2), "selectionStart" in c3) c3.selectionStart = b2, c3.selectionEnd = Math.min(a3, c3.value.length);
            else if (a3 = (b2 = c3.ownerDocument || document) && b2.defaultView || window, a3.getSelection) {
              a3 = a3.getSelection();
          ...
          b2 = [];
          for (a3 = c3; a3 = a3.parentNode; ) 1 === a3.nodeType && b2.push({ element: a3, left: a3.scrollLeft, top: a3.scrollTop });
          "function" === typeof c3.focus && c3.focus();
          for (c3 = 0; c3 < b2.length; c3++) a3 = b2[c3], a3.element.scrollLeft = a3.left, a3.element.scrollTop = a3.top;
        }
      }
      ...
      function Ze(a3) {
        ...
        if (!We[a3]) return a3;
        var b2 = We[a3], c3;
        for (c3 in b2) if (b2.hasOwnProperty(c3) && c3 in Ye) return Xe[a3] = b2[c3];
        return a3;
      }
      ...
      function D2(a3, b2) {
        ...
        var d2 = a3 + "__bubble";
        c3.has(d2) || (pf(b2, a3, 2, false), c3.add(d2));
      }
      ...
      function pf(a3, b2, c3, d2) {
        ...
        c3 = e2.bind(null, b2, c3, a3);
        e2 = void 0;
        !Lb || "touchstart" !== b2 && "touchmove" !== b2 && "wheel" !== b2 || (e2 = true);
        d2 ? void 0 !== e2 ? a3.addEventListener(b2, c3, { capture: true, passive: e2 }) : a3.addEventListener(b2, c3, true) : void 0 !== e2 ? a3.addEventListener(b2, c3, { passive: e2 }) : a3.addEventListener(b2, c3, false);
      }
      function hd(a3, b2, c3, d2, e2) {
        var f2 = d2;
        ...
        Jb(function() {
          ...
          a: {
            ...
            if (void 0 !== h3) {
              ...
              var t3 = 0 !== (b2 & 4), J2 = !t3 && "scroll" === a3, x3 = t3 ? null !== h3 ? h3 + "Capture" : null : h3;
              t3 = [];
              for (var w2 = d3, u2; null !== w2; ) {
                u2 = w2;
                var F = u2.stateNode;
                5 === u2.tag && null !== F && (u2 = F, null !== x3 && (F = Kb(w2, x3), null != F && t3.push(tf(w2, F, u2))));
                if (J2) break;
                w2 = w2.return;
              }
              0 < t3.length && (h3 = new k3(h3, n2, null, c3, e3), g3.push({ event: h3, listeners: t3 }));
            }
          }
          if (0 === (b2 & 7)) {
            a: {
              ...
              if (k3 || h3) {
                ...
                if (k3) {
                  if (n2 = c3.relatedTarget || c3.toElement, k3 = d3, n2 = n2 ? Wc(n2) : null, null !== n2 && (J2 = Vb(n2), n2 !== J2 || 5 !== n2.tag && 6 !== n2.tag)) n2 = null;
                } else k3 = null, n2 = d3;
                if (k3 !== n2) {
                  t3 = Bd;
                  F = "onMouseLeave";
                  x3 = "onMouseEnter";
                  w2 = "mouse";
                  if ("pointerout" === a3 || "pointerover" === a3) t3 = Td, F = "onPointerLeave", x3 = "onPointerEnter", w2 = "pointer";
                  J2 = null == k3 ? h3 : ue(k3);
                  u2 = null == n2 ? h3 : ue(n2);
                  h3 = new t3(F, w2 + "leave", k3, c3, e3);
                  h3.target = J2;
                  h3.relatedTarget = u2;
                  F = null;
                  Wc(e3) === d3 && (t3 = new t3(x3, w2 + "enter", n2, c3, e3), t3.target = u2, t3.relatedTarget = J2, F = t3);
                  J2 = F;
                  if (k3 && n2) b: {
                    t3 = k3;
                    x3 = n2;
                    ...
                    u2 = 0;
                    for (F = x3; F; F = vf(F)) u2++;
                    for (; 0 < w2 - u2; ) t3 = vf(t3), w2--;
                    for (; 0 < u2 - w2; ) x3 = vf(x3), u2--;
                    for (; w2--; ) {
            ...
            ba && (de && "ko" !== c3.locale && (ie || "onCompositionStart" !== ba ? "onCompositionEnd" === ba && ie && ($a = nd()) : (kd = e3, ld = "value" in kd ? kd.value : kd.textContent, ie = true)), xa = oe(d3, ba), 0 < xa.length && (ba = new Ld(ba, a3, null, c3, e3), g3.push({ event: ba, listeners: xa }), $a ? ba.data = $a : ($a = he(c3), null !== $a && (ba.data = $a))));
            if ($a = ce ? je(a3, c3) : ke(a3, c3)) d3 = oe(d3, "onBeforeInput"), 0 < d3.length && (e3 = new Ld("onBeforeInput", "beforeinput", null, c3, e3), g3.push({ event: e3, listeners: d3 }), e3.data = $a);
          }
          se(g3, b2);
        });
      }
      function tf(a3, b2, c3) {
        return { instance: a3, listener: b2, currentTarget: c3 };
      }
      function oe(a3, b2) {
        for (var c3 = b2 + "Capture", d2 = []; null !== a3; ) {
          var e2 = a3, f2 = e2.stateNode;
          5 === e2.tag && null !== f2 && (e2 = f2, f2 = Kb(a3, c3), null != f2 && d2.unshift(tf(a3, f2, e2)), f2 = Kb(a3, b2), null != f2 && d2.push(tf(a3, f2, e2)));
          a3 = a3.return;
        }
        return d2;
      }
      ...
      function Af(a3, b2, c3) {
        b2 = zf(b2);
        if (zf(a3) !== b2 && c3) throw Error(p2(425));
      }
      function Bf() {
      }
      var Cf = null;
      ...
      function Kf(a3, b2) {
        ...
        do {
          ...
          a3.removeChild(c3);
          if (e2 && 8 === e2.nodeType) if (c3 = e2.data, "/$" === c3) {
            if (0 === d2) {
              a3.removeChild(e2);
              bd(b2);
              return;
      ...
      function Wc(a3) {
        ...
        for (var c3 = a3.parentNode; c3; ) {
          if (b2 = c3[uf] || c3[Of]) {
            c3 = b2.alternate;
            if (null !== b2.child || null !== c3 && null !== c3.child) for (a3 = Mf(a3); null !== a3; ) {
      ...
      function ag(a3, b2, c3) {
        if (H2.current !== Vf) throw Error(p2(168));
        G2(H2, b2);
        G2(Wf, c3);
      }
      function bg(a3, b2, c3) {
        var d2 = a3.stateNode;
        b2 = b2.childContextTypes;
        if ("function" !== typeof d2.getChildContext) return c3;
      ...
      function dg(a3, b2, c3) {
        var d2 = a3.stateNode;
        if (!d2) throw Error(p2(169));
        c3 ? (a3 = bg(a3, b2, Xf), d2.__reactInternalMemoizedMergedChildContext = a3, E2(Wf), E2(H2), G2(H2, a3)) : E2(Wf);
        G2(Wf, c3);
      }
      var eg = null;
      var fg = false;
      ...
      function Ag(a3, b2) {
        ...
        c3.return = a3;
        b2 = a3.deletions;
        null === b2 ? (a3.deletions = [c3], a3.flags |= 16) : b2.push(c3);
      }
      function Cg(a3, b2) {
        switch (a3.tag) {
          case 5:
          ...
          case 13:
            return b2 = 8 !== b2.nodeType ? null : b2, null !== b2 ? (c3 = null !== qg ? { id: rg, overflow: sg } : null, a3.memoizedState = { dehydrated: b2, treeContext: c3, retryLane: 1073741824 }, c3 = Bg(18, null, null, 0), c3.stateNode = b2, c3.return = a3, a3.child = c3, xg = a3, yg = null, true) : false;
          default:
            return false;
        }
      }
        ...
        if (I2) {
          ...
          if (b2) {
            ...
            if (!Cg(a3, b2)) {
              ...
              var d2 = xg;
              b2 && Cg(a3, b2) ? Ag(d2, c3) : (a3.flags = a3.flags & -4097 | 2, I2 = false, xg = a3);
            }
          } else {
            if (Dg(a3)) throw Error(p2(418));
      ...
      function Lg(a3, b2, c3) {
        a3 = c3.ref;
        if (null !== a3 && "function" !== typeof a3 && "object" !== typeof a3) {
          if (c3._owner) {
            c3 = c3._owner;
            if (c3) {
              if (1 !== c3.tag) throw Error(p2(309));
              var d2 = c3.stateNode;
            }
          ...
          if (!c3._owner) throw Error(p2(290, a3));
        }
        return a3;
      }
      function Mg(a3, b2) {
      ...
      function Og(a3) {
        ...
        function c3(c4, d3) {
          if (!a3) return null;
          for (; null !== d3; ) b2(c4, d3), d3 = d3.sibling;
          return null;
        }
        function d2(a4, b3) {
        ...
        function f2(b3, c4, d3) {
          b3.index = d3;
          if (!a3) return b3.flags |= 1048576, c4;
          d3 = b3.alternate;
          if (null !== d3) return d3 = d3.index, d3 < c4 ? (b3.flags |= 2, c4) : d3;
          b3.flags |= 2;
          return c4;
        }
        function g2(b3) {
        ...
        function h2(a4, b3, c4, d3) {
          if (null === b3 || 6 !== b3.tag) return b3 = Qg(c4, a4.mode, d3), b3.return = a4, b3;
          b3 = e2(b3, c4);
          b3.return = a4;
          return b3;
        }
        function k2(a4, b3, c4, d3) {
          var f3 = c4.type;
          if (f3 === ya) return m3(a4, b3, c4.props.children, d3, c4.key);
          if (null !== b3 && (b3.elementType === f3 || "object" === typeof f3 && null !== f3 && f3.$$typeof === Ha && Ng(f3) === b3.type)) return d3 = e2(b3, c4.props), d3.ref = Lg(a4, b3, c4), d3.return = a4, d3;
          d3 = Rg(c4.type, c4.key, c4.props, null, a4.mode, d3);
          d3.ref = Lg(a4, b3, c4);
          d3.return = a4;
          return d3;
        }
        function l2(a4, b3, c4, d3) {
          if (null === b3 || 4 !== b3.tag || b3.stateNode.containerInfo !== c4.containerInfo || b3.stateNode.implementation !== c4.implementation) return b3 = Sg(c4, a4.mode, d3), b3.return = a4, b3;
          b3 = e2(b3, c4.children || []);
          b3.return = a4;
          return b3;
        }
        function m3(a4, b3, c4, d3, f3) {
          if (null === b3 || 7 !== b3.tag) return b3 = Tg(c4, a4.mode, d3, f3), b3.return = a4, b3;
          b3 = e2(b3, c4);
          b3.return = a4;
          return b3;
        }
        function q2(a4, b3, c4) {
          if ("string" === typeof b3 && "" !== b3 || "number" === typeof b3) return b3 = Qg("" + b3, a4.mode, c4), b3.return = a4, b3;
          if ("object" === typeof b3 && null !== b3) {
            switch (b3.$$typeof) {
              case va:
                return c4 = Rg(b3.type, b3.key, b3.props, null, a4.mode, c4), c4.ref = Lg(a4, null, b3), c4.return = a4, c4;
              case wa:
                return b3 = Sg(b3, a4.mode, c4), b3.return = a4, b3;
              case Ha:
                var d3 = b3._init;
                return q2(a4, d3(b3._payload), c4);
            }
            if (eb(b3) || Ka(b3)) return b3 = Tg(b3, a4.mode, c4, null), b3.return = a4, b3;
            Mg(a4, b3);
          }
          return null;
        }
        function r2(a4, b3, c4, d3) {
          var e3 = null !== b3 ? b3.key : null;
          if ("string" === typeof c4 && "" !== c4 || "number" === typeof c4) return null !== e3 ? null : h2(a4, b3, "" + c4, d3);
          if ("object" === typeof c4 && null !== c4) {
            switch (c4.$$typeof) {
              case va:
                return c4.key === e3 ? k2(a4, b3, c4, d3) : null;
              case wa:
                return c4.key === e3 ? l2(a4, b3, c4, d3) : null;
              case Ha:
            ...
            if (eb(c4) || Ka(c4)) return null !== e3 ? null : m3(a4, b3, c4, d3, null);
            Mg(a4, c4);
          }
          return null;
        }
        function y3(a4, b3, c4, d3, e3) {
          if ("string" === typeof d3 && "" !== d3 || "number" === typeof d3) return a4 = a4.get(c4) || null, h2(b3, a4, "" + d3, e3);
          if ("object" === typeof d3 && null !== d3) {
            switch (d3.$$typeof) {
              case va:
                return a4 = a4.get(null === d3.key ? c4 : d3.key) || null, k2(b3, a4, d3, e3);
              case wa:
                return a4 = a4.get(null === d3.key ? c4 : d3.key) || null, l2(b3, a4, d3, e3);
              case Ha:
                var f3 = d3._init;
                return y3(a4, b3, c4, f3(d3._payload), e3);
            }
            if (eb(d3) || Ka(d3)) return a4 = a4.get(c4) || null, m3(b3, a4, d3, e3, null);
            Mg(b3, d3);
          }
          return null;
        }
        function n2(e3, g3, h3, k3) {
          for (var l3 = null, m4 = null, u2 = g3, w2 = g3 = 0, x3 = null; null !== u2 && w2 < h3.length; w2++) {
            ...
            g3 = f2(n3, g3, w2);
            null === m4 ? l3 = n3 : m4.sibling = n3;
            m4 = n3;
            u2 = x3;
          }
          if (w2 === h3.length) return c3(e3, u2), I2 && tg(e3, w2), l3;
          if (null === u2) {
            for (; w2 < h3.length; w2++) u2 = q2(e3, h3[w2], k3), null !== u2 && (g3 = f2(u2, g3, w2), null === m4 ? l3 = u2 : m4.sibling = u2, m4 = u2);
            I2 && tg(e3, w2);
            return l3;
          }
          for (u2 = d2(e3, u2); w2 < h3.length; w2++) x3 = y3(u2, e3, w2, h3[w2], k3), null !== x3 && (a3 && null !== x3.alternate && u2.delete(null === x3.key ? w2 : x3.key), g3 = f2(x3, g3, w2), null === m4 ? l3 = x3 : m4.sibling = x3, m4 = x3);
        ...
        function t3(e3, g3, h3, k3) {
          ...
          for (var u2 = l3 = null, m4 = g3, w2 = g3 = 0, x3 = null, n3 = h3.next(); null !== m4 && !n3.done; w2++, n3 = h3.next()) {
            m4.index > w2 ? (x3 = m4, m4 = null) : x3 = m4.sibling;
            var t4 = r2(e3, m4, n3.value, k3);
            if (null === t4) {
              null === m4 && (m4 = x3);
              break;
            }
            a3 && m4 && null === t4.alternate && b2(e3, m4);
            g3 = f2(t4, g3, w2);
          ...
          for (m4 = d2(e3, m4); !n3.done; w2++, n3 = h3.next()) n3 = y3(m4, e3, w2, n3.value, k3), null !== n3 && (a3 && null !== n3.alternate && m4.delete(null === n3.key ? w2 : n3.key), g3 = f2(n3, g3, w2), null === u2 ? l3 = n3 : u2.sibling = n3, u2 = n3);
        ...
        function J2(a4, d3, f3, h3) {
          ...
          if ("object" === typeof f3 && null !== f3) {
            ...
            if (Ka(f3)) return t3(a4, d3, f3, h3);
            Mg(a4, f3);
          }
          return "string" === typeof f3 && "" !== f3 || "number" === typeof f3 ? (f3 = "" + f3, null !== d3 && 6 === d3.tag ? (c3(a4, d3.sibling), d3 = e2(d3, f3), d3.return = a4, a4 = d3) : (c3(a4, d3), d3 = Qg(f3, a4.mode, h3), d3.return = a4, a4 = d3), g2(a4)) : c3(a4, d3);
        }
        return J2;
      }
      var Ug = Og(true);
      ...
      function hh(a3, b2, c3, d2) {
        var e2 = b2.interleaved;
        null === e2 ? (c3.next = c3, gh(b2)) : (c3.next = e2.next, e2.next = c3);
        b2.interleaved = c3;
        return ih(a3, d2);
      }
      function ih(a3, b2) {
        ...
        null !== c3 && (c3.lanes |= b2);
        c3 = a3;
        for (a3 = a3.return; null !== a3; ) a3.childLanes |= b2, c3 = a3.alternate, null !== c3 && (c3.childLanes |= b2), c3 = a3, a3 = a3.return;
      ...
      function ph(a3, b2) {
        var c3 = a3.updateQueue, d2 = a3.alternate;
        ...
        null === a3 ? c3.firstBaseUpdate = b2 : a3.next = b2;
        c3.lastBaseUpdate = b2;
      }
      function qh(a3, b2, c3, d2) {
        ...
        if (null !== f2) {
          ...
          do {
            ...
            } else y3 = { eventTime: y3, lane: r2, tag: h2.tag, payload: h2.payload, callback: h2.callback, next: null }, null === m3 ? (l2 = m3 = y3, k2 = q2) : m3 = m3.next = y3, g2 |= r2;
            h2 = h2.next;
      ...
      function Ah(a3) {
        ...
        var c3 = lb(b2, a3.type);
        b2 !== c3 && (G2(vh, a3), G2(uh, c3));
      }
      function Bh(a3) {
      ...
      function Mh(a3, b2) {
        ...
        for (var c3 = 0; c3 < b2.length && c3 < a3.length; c3++) if (!He(a3[c3], b2[c3])) return false;
        return true;
      }
      function Nh(a3, b2, c3, d2, e2, f2) {
        Hh = f2;
        M = b2;
      ...
      function Th() {
        ...
        null === O2 ? M.memoizedState = O2 = a3 : O2 = O2.next = a3;
        return O2;
      }
      function Uh() {
        if (null === N2) {
      ...
      function Wh(a3) {
        ...
        if (null === c3) throw Error(p2(311));
        c3.lastRenderedReducer = a3;
        var d2 = N2, e2 = d2.baseQueue, f2 = c3.pending;
        if (null !== f2) {
          if (null !== e2) {
            var g2 = e2.next;
            e2.next = f2.next;
        ...
        if (null !== e2) {
          ...
          do {
            var m3 = l2.lane;
            if ((Hh & m3) === m3) null !== k2 && (k2 = k2.next = { lane: 0, action: l2.action, hasEagerState: l2.hasEagerState, eagerState: l2.eagerState, next: null }), d2 = l2.hasEagerState ? l2.eagerState : a3(d2, l2.action);
            else {
              var q2 = {
                lane: m3,
                action: l2.action,
      ...
      function Zh(a3, b2) {
        var c3 = M, d2 = Uh(), e2 = b2(), f2 = !He(d2.memoizedState, e2);
        f2 && (d2.memoizedState = e2, dh = true);
        d2 = d2.queue;
        $h(ai.bind(null, c3, d2, a3), [a3]);
        if (d2.getSnapshot !== b2 || f2 || null !== O2 && O2.memoizedState.tag & 1) {
          c3.flags |= 2048;
          bi(9, ci.bind(null, c3, d2, e2, b2), void 0, null);
          if (null === Q2) throw Error(p2(349));
          0 !== (Hh & 30) || di(c3, b2, e2);
        }
        return e2;
      }
      function di(a3, b2, c3) {
        a3.flags |= 16384;
        a3 = { getSnapshot: b2, value: c3 };
        b2 = M.updateQueue;
        null === b2 ? (b2 = { lastEffect: null, stores: null }, M.updateQueue = b2, b2.stores = [a3]) : (c3 = b2.stores, null === c3 ? b2.stores = [a3] : c3.push(a3));
      }
      function ci(a3, b2, c3, d2) {
        b2.value = c3;
        b2.getSnapshot = d2;
        ei(b2) && fi(a3);
      }
      function ai(a3, b2, c3) {
        return c3(function() {
          ei(b2) && fi(a3);
        });
      }
      ...
      function bi(a3, b2, c3, d2) {
        a3 = { tag: a3, create: b2, destroy: c3, deps: d2, next: null };
        b2 = M.updateQueue;
        null === b2 ? (b2 = { lastEffect: null, stores: null }, M.updateQueue = b2, b2.lastEffect = a3.next = a3) : (c3 = b2.lastEffect, null === c3 ? b2.lastEffect = a3.next = a3 : (d2 = c3.next, c3.next = a3, a3.next = d2, b2.lastEffect = a3));
        return a3;
      }
      function ji() {
        return Uh().memoizedState;
      }
      function ki(a3, b2, c3, d2) {
        var e2 = Th();
        M.flags |= a3;
        e2.memoizedState = bi(1 | b2, c3, void 0, void 0 === d2 ? null : d2);
      }
      function li(a3, b2, c3, d2) {
        var e2 = Uh();
        ...
        if (null !== N2) {
          ...
          if (null !== d2 && Mh(d2, g2.deps)) {
            e2.memoizedState = bi(b2, c3, f2, d2);
            return;
          }
        }
        M.flags |= a3;
        e2.memoizedState = bi(1 | b2, c3, f2, d2);
      }
      function mi(a3, b2) {
      ...
      function qi(a3, b2, c3) {
        c3 = null !== c3 && void 0 !== c3 ? c3.concat([a3]) : null;
        return li(4, 4, pi3.bind(null, b2, a3), c3);
      }
      function ri() {
      }
      function si(a3, b2) {
      ...
      function vi(a3, b2) {
        ...
        try {
          ...
          C2 = c3, Gh.transition = d2;
        }
      }
      function wi() {
        return Uh().memoizedState;
      }
      function xi(a3, b2, c3) {
        var d2 = yi(a3);
        c3 = { lane: d2, action: c3, hasEagerState: false, eagerState: null, next: null };
        if (zi(a3)) Ai(b2, c3);
        else if (c3 = hh(a3, b2, c3, d2), null !== c3) {
          var e2 = R2();
          gi(c3, a3, d2, e2);
          Bi(c3, b2, d2);
        }
      }
      function ii(a3, b2, c3) {
        var d2 = yi(a3), e2 = { lane: d2, action: c3, hasEagerState: false, eagerState: null, next: null };
        if (zi(a3)) Ai(b2, e2);
        else {
          var f2 = a3.alternate;
          ...
          c3 = hh(a3, b2, e2, d2);
          null !== c3 && (e2 = R2(), gi(c3, a3, d2, e2), Bi(c3, b2, d2));
        }
      }
      function zi(a3) {
        var b2 = a3.alternate;
      ...
      var Oh = { readContext: eh, useCallback: function(a3, b2) {
        Th().memoizedState = [a3, void 0 === b2 ? null : b2];
        return a3;
      }, useContext: eh, useEffect: mi, useImperativeHandle: function(a3, b2, c3) {
        c3 = null !== c3 && void 0 !== c3 ? c3.concat([a3]) : null;
        return ki(
          4194308,
          4,
      ...
      }, useSyncExternalStore: function(a3, b2, c3) {
        var d2 = M, e2 = Th();
        if (I2) {
          if (void 0 === c3) throw Error(p2(407));
          c3 = c3();
        } else {
          c3 = b2();
          if (null === Q2) throw Error(p2(349));
        ...
        d2.flags |= 2048;
        bi(9, ci.bind(null, d2, f2, c3, b2), void 0, null);
        return c3;
      }, useId: function() {
        var a3 = Th(), b2 = Q2.identifierPrefix;
        if (I2) {
          var c3 = sg;
          var d2 = rg;
      ...
      function Ci(a3, b2) {
        if (a3 && a3.defaultProps) {
          b2 = A2({}, b2);
          a3 = a3.defaultProps;
          for (var c3 in a3) void 0 === b2[c3] && (b2[c3] = a3[c3]);
          return b2;
        }
        return b2;
      }
      function Di(a3, b2, c3, d2) {
        b2 = a3.memoizedState;
        c3 = c3(d2, b2);
      ...
      var Ei = { isMounted: function(a3) {
      ...
      }, enqueueSetState: function(a3, b2, c3) {
        a3 = a3._reactInternals;
        var d2 = R2(), e2 = yi(a3), f2 = mh(d2, e2);
        f2.payload = b2;
        void 0 !== c3 && null !== c3 && (f2.callback = c3);
        b2 = nh(a3, f2, e2);
        null !== b2 && (gi(b2, a3, e2, d2), oh(b2, a3, e2));
      }, enqueueReplaceState: function(a3, b2, c3) {
        a3 = a3._reactInternals;
        var d2 = R2(), e2 = yi(a3), f2 = mh(d2, e2);
        f2.tag = 1;
        f2.payload = b2;
        ...
        a3 = a3._reactInternals;
        var c3 = R2(), d2 = yi(a3), e2 = mh(c3, d2);
        e2.tag = 2;
        void 0 !== b2 && null !== b2 && (e2.callback = b2);
        b2 = nh(a3, e2, d2);
        null !== b2 && (gi(b2, a3, d2, c3), oh(b2, a3, d2));
      } };
      function Fi(a3, b2, c3, d2, e2, f2, g2) {
        a3 = a3.stateNode;
        return "function" === typeof a3.shouldComponentUpdate ? a3.shouldComponentUpdate(d2, f2, g2) : b2.prototype && b2.prototype.isPureReactComponent ? !Ie(c3, d2) || !Ie(e2, f2) : true;
      }
      function Gi(a3, b2, c3) {
        var d2 = false, e2 = Vf;
      ...
      function Ii(a3, b2, c3, d2) {
        ...
        "function" === typeof f2 && (Di(a3, b2, f2, c3), e2.state = a3.memoizedState);
        "function" === typeof b2.getDerivedStateFromProps || "function" === typeof e2.getSnapshotBeforeUpdate || "function" !== typeof e2.UNSAFE_componentWillMount && "function" !== typeof e2.componentWillMount || (b2 = e2.state, "function" === typeof e2.componentWillMount && e2.componentWillMount(), "function" === typeof e2.UNSAFE_componentWillMount && e2.UNSAFE_componentWillMount(), b2 !== e2.state && Ei.enqueueReplaceState(e2, e2.state, null), qh(a3, c3, e2, d2), e2.state = a3.memoizedState);
      ...
      function Ki(a3, b2, c3) {
        return { value: a3, source: null, stack: null != c3 ? c3 : null, digest: null != b2 ? b2 : null };
      }
      function Li(a3, b2) {
        try {
      ...
      function Si(a3, b2, c3) {
        ...
        e2.has(c3) || (e2.add(c3), a3 = Ti.bind(null, a3, b2, c3), b2.then(a3, a3));
      }
      function Ui(a3) {
        do {
          var b2;
      ...
      function Vi(a3, b2, c3, d2, e2) {
        if (0 === (a3.mode & 1)) return a3 === b2 ? a3.flags |= 65536 : (a3.flags |= 128, c3.flags |= 131072, c3.flags &= -52805, 1 === c3.tag && (null === c3.alternate ? c3.tag = 17 : (b2 = mh(-1, 1), b2.tag = 2, nh(c3, b2, 1))), c3.lanes |= 1), a3;
        a3.flags |= 65536;
        a3.lanes = e2;
        return a3;
      }
      ...
      var dh = false;
      function Xi(a3, b2, c3, d2) {
        b2.child = null === a3 ? Vg(b2, null, c3, d2) : Ug(b2, a3.child, c3, d2);
      }
      function Yi(a3, b2, c3, d2, e2) {
        c3 = c3.render;
        var f2 = b2.ref;
        ch(b2, e2);
        d2 = Nh(a3, b2, c3, d2, f2, e2);
        c3 = Sh();
      ...
      function $i(a3, b2, c3, d2, e2) {
        if (null === a3) {
          var f2 = c3.type;
          if ("function" === typeof f2 && !aj(f2) && void 0 === f2.defaultProps && null === c3.compare && void 0 === c3.defaultProps) return b2.tag = 15, b2.type = f2, bj(a3, b2, f2, d2, e2);
          a3 = Rg(c3.type, null, d2, b2, b2.mode, e2);
          a3.ref = b2.ref;
          a3.return = b2;
          return b2.child = a3;
        }
        ...
        if (0 === (a3.lanes & e2)) {
          ...
          c3 = c3.compare;
          c3 = null !== c3 ? c3 : Ie;
          if (c3(g2, d2) && a3.ref === b2.ref) return Zi(a3, b2, e2);
        }
        b2.flags |= 1;
        a3 = Pg(f2, d2);
        a3.ref = b2.ref;
      ...
      function bj(a3, b2, c3, d2, e2) {
        if (null !== a3) {
          var f2 = a3.memoizedProps;
          if (Ie(f2, d2) && a3.ref === b2.ref) if (dh = false, b2.pendingProps = d2 = f2, 0 !== (a3.lanes & e2)) 0 !== (a3.flags & 131072) && (dh = true);
          else return b2.lanes = a3.lanes, Zi(a3, b2, e2);
        }
        return cj(a3, b2, c3, d2, e2);
      }
      function dj(a3, b2, c3) {
        var d2 = b2.pendingProps, e2 = d2.children, f2 = null !== a3 ? a3.memoizedState : null;
        if ("hidden" === d2.mode) if (0 === (b2.mode & 1)) b2.memoizedState = { baseLanes: 0, cachePool: null, transitions: null }, G2(ej, fj), fj |= c3;
        else {
          if (0 === (c3 & 1073741824)) return a3 = null !== f2 ? f2.baseLanes | c3 : c3, b2.lanes = b2.childLanes = 1073741824, b2.memoizedState = { baseLanes: a3, cachePool: null, transitions: null }, b2.updateQueue = null, G2(ej, fj), fj |= a3, null;
          b2.memoizedState = { baseLanes: 0, cachePool: null, transitions: null };
          d2 = null !== f2 ? f2.baseLanes : c3;
          G2(ej, fj);
          fj |= d2;
        }
        else null !== f2 ? (d2 = f2.baseLanes | c3, b2.memoizedState = null) : d2 = c3, G2(ej, fj), fj |= d2;
        Xi(a3, b2, e2, c3);
        return b2.child;
      }
      function gj(a3, b2) {
        var c3 = b2.ref;
        if (null === a3 && null !== c3 || null !== a3 && a3.ref !== c3) b2.flags |= 512, b2.flags |= 2097152;
      }
      function cj(a3, b2, c3, d2, e2) {
        var f2 = Zf(c3) ? Xf : H2.current;
        f2 = Yf(b2, f2);
        ch(b2, e2);
        c3 = Nh(a3, b2, c3, d2, f2, e2);
        d2 = Sh();
        if (null !== a3 && !dh) return b2.updateQueue = a3.updateQueue, b2.flags &= -2053, a3.lanes &= ~e2, Zi(a3, b2, e2);
        I2 && d2 && vg(b2);
        b2.flags |= 1;
      ...
      function hj(a3, b2, c3, d2, e2) {
        if (Zf(c3)) {
          var f2 = true;
          cg(b2);
        } else f2 = false;
        ch(b2, e2);
        if (null === b2.stateNode) ij(a3, b2), Gi(b2, c3, d2), Ii(b2, c3, d2, e2), d2 = true;
        else if (null === a3) {
          var g2 = b2.stateNode, h2 = b2.memoizedProps;
          g2.props = h2;
          var k2 = g2.context, l2 = c3.contextType;
          "object" === typeof l2 && null !== l2 ? l2 = eh(l2) : (l2 = Zf(c3) ? Xf : H2.current, l2 = Yf(b2, l2));
          var m3 = c3.getDerivedStateFromProps, q2 = "function" === typeof m3 || "function" === typeof g2.getSnapshotBeforeUpdate;
          ...
          qh(b2, d2, g2, e2);
          k2 = b2.memoizedState;
          h2 !== d2 || r2 !== k2 || Wf.current || jh ? ("function" === typeof m3 && (Di(b2, c3, m3, d2), k2 = b2.memoizedState), (h2 = jh || Fi(b2, c3, h2, d2, r2, k2, l2)) ? (q2 || "function" !== typeof g2.UNSAFE_componentWillMount && "function" !== typeof g2.componentWillMount || ("function" === typeof g2.componentWillMount && g2.componentWillMount(), "function" === typeof g2.UNSAFE_componentWillMount && g2.UNSAFE_componentWillMount()), "function" === typeof g2.componentDidMount && (b2.flags |= 4194308)) : ("function" === typeof g2.componentDidMount && (b2.flags |= 4194308), b2.memoizedProps = d2, b2.memoizedState = k2), g2.props = d2, g2.state = k2, g2.context = l2, d2 = h2) : ("function" === typeof g2.componentDidMount && (b2.flags |= 4194308), d2 = false);
        } else {
          g2 = b2.stateNode;
          lh(a3, b2);
          h2 = b2.memoizedProps;
          ...
          r2 = g2.context;
          k2 = c3.contextType;
          "object" === typeof k2 && null !== k2 ? k2 = eh(k2) : (k2 = Zf(c3) ? Xf : H2.current, k2 = Yf(b2, k2));
          var y3 = c3.getDerivedStateFromProps;
          (m3 = "function" === typeof y3 || "function" === typeof g2.getSnapshotBeforeUpdate) || "function" !== typeof g2.UNSAFE_componentWillReceiveProps && "function" !== typeof g2.componentWillReceiveProps || (h2 !== q2 || r2 !== k2) && Hi(b2, g2, d2, k2);
          jh = false;
          r2 = b2.memoizedState;
          g2.state = r2;
          qh(b2, d2, g2, e2);
          var n2 = b2.memoizedState;
          h2 !== q2 || r2 !== n2 || Wf.current || jh ? ("function" === typeof y3 && (Di(b2, c3, y3, d2), n2 = b2.memoizedState), (l2 = jh || Fi(b2, c3, l2, d2, r2, n2, k2) || false) ? (m3 || "function" !== typeof g2.UNSAFE_componentWillUpdate && "function" !== typeof g2.componentWillUpdate || ("function" === typeof g2.componentWillUpdate && g2.componentWillUpdate(d2, n2, k2), "function" === typeof g2.UNSAFE_componentWillUpdate && g2.UNSAFE_componentWillUpdate(d2, n2, k2)), "function" === typeof g2.componentDidUpdate && (b2.flags |= 4), "function" === typeof g2.getSnapshotBeforeUpdate && (b2.flags |= 1024)) : ("function" !== typeof g2.componentDidUpdate || h2 === a3.memoizedProps && r2 === a3.memoizedState || (b2.flags |= 4), "function" !== typeof g2.getSnapshotBeforeUpdate || h2 === a3.memoizedProps && r2 === a3.memoizedState || (b2.flags |= 1024), b2.memoizedProps = d2, b2.memoizedState = n2), g2.props = d2, g2.state = n2, g2.context = k2, d2 = l2) : ("function" !== typeof g2.componentDidUpdate || h2 === a3.memoizedProps && r2 === a3.memoizedState || (b2.flags |= 4), "function" !== typeof g2.getSnapshotBeforeUpdate || h2 === a3.memoizedProps && r2 === a3.memoizedState || (b2.flags |= 1024), d2 = false);
        }
        return jj(a3, b2, c3, d2, f2, e2);
      }
      function jj(a3, b2, c3, d2, e2, f2) {
        gj(a3, b2);
        var g2 = 0 !== (b2.flags & 128);
        if (!d2 && !g2) return e2 && dg(b2, c3, false), Zi(a3, b2, f2);
        d2 = b2.stateNode;
        Wi.current = b2;
      ...
      function oj(a3, b2, c3) {
        ...
        if (null === a3) {
          ...
          g2 = d2.children;
          a3 = d2.fallback;
          return f2 ? (d2 = b2.mode, f2 = b2.child, g2 = { mode: "hidden", children: g2 }, 0 === (d2 & 1) && null !== f2 ? (f2.childLanes = 0, f2.pendingProps = g2) : f2 = pj(g2, d2, 0, null), a3 = Tg(a3, d2, c3, null), f2.return = b2, a3.return = b2, f2.sibling = a3, b2.child = f2, b2.child.memoizedState = nj(c3), b2.memoizedState = mj, a3) : qj(b2, g2);
        }
        e2 = a3.memoizedState;
        if (null !== e2 && (h2 = e2.dehydrated, null !== h2)) return rj(a3, b2, g2, d2, h2, e2, c3);
        if (f2) {
          f2 = d2.fallback;
          g2 = b2.mode;
          e2 = a3.child;
          ...
          null !== h2 ? f2 = Pg(h2, f2) : (f2 = Tg(f2, g2, c3, null), f2.flags |= 2);
          f2.return = b2;
          d2.return = b2;
          d2.sibling = f2;
          b2.child = d2;
        ...
        d2.return = b2;
        d2.sibling = null;
        null !== a3 && (c3 = b2.deletions, null === c3 ? (b2.deletions = [a3], b2.flags |= 16) : c3.push(a3));
        b2.child = d2;
        b2.memoizedState = null;
        return d2;
      }
      ...
      function sj(a3, b2, c3, d2) {
        null !== d2 && Jg(d2);
        Ug(b2, a3.child, null, c3);
        a3 = qj(b2, b2.pendingProps.children);
        a3.flags |= 2;
        b2.memoizedState = null;
        return a3;
      }
      function rj(a3, b2, c3, d2, e2, f2, g2) {
        if (c3) {
      ...
      function vj(a3, b2, c3) {
        a3.lanes |= b2;
        var d2 = a3.alternate;
        null !== d2 && (d2.lanes |= b2);
        bh(a3.return, b2, c3);
      }
      function wj(a3, b2, c3, d2, e2) {
        var f2 = a3.memoizedState;
        null === f2 ? a3.memoizedState = { isBackwards: b2, rendering: null, renderingStartTime: 0, last: d2, tail: c3, tailMode: e2 } : (f2.isBackwards = b2, f2.rendering = null, f2.renderingStartTime = 0, f2.last = d2, f2.tail = c3, f2.tailMode = e2);
      }
      function xj(a3, b2, c3) {
        var d2 = b2.pendingProps, e2 = d2.revealOrder, f2 = d2.tail;
        Xi(a3, b2, d2.children, c3);
        d2 = L2.current;
        if (0 !== (d2 & 2)) d2 = d2 & 1 | 2, b2.flags |= 128;
        else {
          if (null !== a3 && 0 !== (a3.flags & 128)) a: for (a3 = b2.child; null !== a3; ) {
            if (13 === a3.tag) null !== a3.memoizedState && vj(a3, c3, b2);
            else if (19 === a3.tag) vj(a3, c3, b2);
        ...
        if (0 === (b2.mode & 1)) b2.memoizedState = null;
          ...
          case "forwards":
            c3 = b2.child;
            for (e2 = null; null !== c3; ) a3 = c3.alternate, null !== a3 && null === Ch(a3) && (e2 = c3), c3 = c3.sibling;
            c3 = e2;
            null === c3 ? (e2 = b2.child, b2.child = null) : (e2 = c3.sibling, c3.sibling = null);
            wj(b2, false, e2, c3, f2);
            break;
          case "backwards":
            c3 = null;
            e2 = b2.child;
      ...
      function Zi(a3, b2, c3) {
        ...
        if (null !== b2.child) {
          ...
          b2.child = c3;
          for (c3.return = b2; null !== a3.sibling; ) a3 = a3.sibling, c3 = c3.sibling = Pg(a3, a3.pendingProps), c3.return = b2;
          c3.sibling = null;
        }
        return b2.child;
      }
        ...
        switch (b2.tag) {
          ...
          case 13:
            ...
            if (null !== d2) {
              ...
              if (0 !== (c3 & b2.child.childLanes)) return oj(a3, b2, c3);
              G2(L2, L2.current & 1);
              a3 = Zi(a3, b2, c3);
      ...
      Bj = function(a3, b2, c3, d2) {
        ...
        if (e2 !== d2) {
          ...
          for (l2 in e2) if (!d2.hasOwnProperty(l2) && e2.hasOwnProperty(l2) && null != e2[l2]) if ("style" === l2) {
            var h2 = e2[l2];
            for (g2 in h2) h2.hasOwnProperty(g2) && (c3 || (c3 = {}), c3[g2] = "");
          } else "dangerouslySetInnerHTML" !== l2 && "children" !== l2 && "suppressContentEditableWarning" !== l2 && "suppressHydrationWarning" !== l2 && "autoFocus" !== l2 && (ea.hasOwnProperty(l2) ? f2 || (f2 = []) : (f2 = f2 || []).push(l2, null));
          for (l2 in d2) {
            var k2 = d2[l2];
            h2 = null != e2 ? e2[l2] : void 0;
            if (d2.hasOwnProperty(l2) && k2 !== h2 && (null != k2 || null != h2)) if ("style" === l2) if (h2) {
              for (g2 in h2) !h2.hasOwnProperty(g2) || k2 && k2.hasOwnProperty(g2) || (c3 || (c3 = {}), c3[g2] = "");
              for (g2 in k2) k2.hasOwnProperty(g2) && h2[g2] !== k2[g2] && (c3 || (c3 = {}), c3[g2] = k2[g2]);
      ...
      function Dj(a3, b2) {
        if (!I2) switch (a3.tailMode) {
          ...
          case "collapsed":
            c3 = a3.tail;
            for (var d2 = null; null !== c3; ) null !== c3.alternate && (d2 = c3), c3 = c3.sibling;
            null === d2 ? b2 || null === a3.tail ? a3.tail = null : a3.tail.sibling = null : d2.sibling = null;
        }
      }
      function S2(a3) {
        var b2 = null !== a3.alternate && a3.alternate.child === a3.child, c3 = 0, d2 = 0;
        if (b2) for (var e2 = a3.child; null !== e2; ) c3 |= e2.lanes | e2.childLanes, d2 |= e2.subtreeFlags & 14680064, d2 |= e2.flags & 14680064, e2.return = a3, e2 = e2.sibling;
        else for (e2 = a3.child; null !== e2; ) c3 |= e2.lanes | e2.childLanes, d2 |= e2.subtreeFlags, d2 |= e2.flags, e2.return = a3, e2 = e2.sibling;
        a3.subtreeFlags |= d2;
        a3.childLanes = c3;
        return b2;
      }
      function Ej(a3, b2, c3) {
        ...
        switch (b2.tag) {
          ...
          case 5:
            ...
            c3 = b2.type;
            if (null !== a3 && null != b2.stateNode) Bj(a3, b2, c3, d2, e2), a3.ref !== b2.ref && (b2.flags |= 512, b2.flags |= 2097152);
            else {
              if (!d2) {
              ...
              if (Gg(b2)) {
                ...
                "http://www.w3.org/1999/xhtml" === a3 ? "script" === c3 ? (a3 = g2.createElement("div"), a3.innerHTML = "<script><\/script>", a3 = a3.removeChild(a3.firstChild)) : "string" === typeof d2.is ? a3 = g2.createElement(c3, { is: d2.is }) : (a3 = g2.createElement(c3), "select" === c3 && (g2 = a3, d2.multiple ? g2.multiple = true : d2.size && (g2.size = d2.size))) : a3 = g2.createElementNS(a3, c3);
                a3[Of] = b2;
                a3[Pf] = d2;
              ...
              if (Gg(b2)) {
                ...
                if (f2 = d2.nodeValue !== c3) {
                  if (a3 = xg, null !== a3) switch (a3.tag) {
                    case 3:
                      Af(d2.nodeValue, c3, 0 !== (a3.mode & 1));
                      break;
                    case 5:
                      true !== a3.memoizedProps.suppressHydrationWarning && Af(d2.nodeValue, c3, 0 !== (a3.mode & 1));
                  }
                }
                f2 && (b2.flags |= 4);
              } else d2 = (9 === c3.nodeType ? c3 : c3.ownerDocument).createTextNode(d2), d2[Of] = b2, b2.stateNode = d2;
            }
            S2(b2);
            return null;
          case 13:
            ...
            d2 = null !== d2;
            d2 !== (null !== a3 && null !== a3.memoizedState) && d2 && (b2.child.flags |= 8192, 0 !== (b2.mode & 1) && (null === a3 || 0 !== (L2.current & 1) ? 0 === T2 && (T2 = 3) : tj()));
          ...
          case 19:
            ...
            if (null === g2) if (d2) Dj(f2, false);
              ...
              if (0 !== T2 || null !== a3 && 0 !== (a3.flags & 128)) for (a3 = b2.child; null !== a3; ) {
                g2 = Ch(a3);
                if (null !== g2) {
                  b2.flags |= 128;
                  Dj(f2, false);
              ...
              if (!d2) if (a3 = Ch(g2), null !== a3) {
                if (b2.flags |= 128, d2 = true, c3 = a3.updateQueue, null !== c3 && (b2.updateQueue = c3, b2.flags |= 4), Dj(f2, true), null === f2.tail && "hidden" === f2.tailMode && !g2.alternate && !I2) return S2(b2), null;
              } else 2 * B2() - f2.renderingStartTime > Gj && 1073741824 !== c3 && (b2.flags |= 128, d2 = true, Dj(f2, false), b2.lanes = 4194304);
              f2.isBackwards ? (g2.sibling = b2.child, b2.child = g2) : (c3 = f2.last, null !== c3 ? c3.sibling = g2 : b2.child = g2, f2.last = g2);
            }
            if (null !== f2.tail) return b2 = f2.tail, f2.rendering = b2, f2.tail = b2.sibling, f2.renderingStartTime = B2(), b2.sibling = null, c3 = L2.current, G2(L2, d2 ? c3 & 1 | 2 : c3 & 1), b2;
            S2(b2);
            return null;
          case 22:
          case 23:
        ...
        if (Ne(a3)) {
          if ("selectionStart" in a3) var c3 = { start: a3.selectionStart, end: a3.selectionEnd };
            ...
            if (d2 && 0 !== d2.rangeCount) {
              ...
              var g2 = 0, h2 = -1, k2 = -1, l2 = 0, m3 = 0, q2 = a3, r2 = null;
              b: for (; ; ) {
                for (var y3; ; ) {
        ...
        for (V2 = b2; null !== V2; ) if (b2 = V2, a3 = b2.child, 0 !== (b2.subtreeFlags & 1028) && null !== a3) a3.return = b2, V2 = a3;
          ...
          try {
            ...
            if (0 !== (b2.flags & 1024)) switch (b2.tag) {
              ...
              case 1:
                if (null !== n2) {
                  var t3 = n2.memoizedProps, J2 = n2.memoizedState, x3 = b2.stateNode, w2 = x3.getSnapshotBeforeUpdate(b2.elementType === b2.type ? t3 : Ci(b2.type, t3), J2);
      ...
      function Vj(a3, b2, c3) {
        var d2 = a3.tag;
        if (5 === d2 || 6 === d2) a3 = a3.stateNode, b2 ? 8 === c3.nodeType ? c3.parentNode.insertBefore(a3, b2) : c3.insertBefore(a3, b2) : (8 === c3.nodeType ? (b2 = c3.parentNode, b2.insertBefore(a3, c3)) : (b2 = c3, b2.appendChild(a3)), c3 = c3._reactRootContainer, null !== c3 && void 0 !== c3 || null !== b2.onclick || (b2.onclick = Bf));
        else if (4 !== d2 && (a3 = a3.child, null !== a3)) for (Vj(a3, b2, c3), a3 = a3.sibling; null !== a3; ) Vj(a3, b2, c3), a3 = a3.sibling;
      }
      function Wj(a3, b2, c3) {
        var d2 = a3.tag;
        if (5 === d2 || 6 === d2) a3 = a3.stateNode, b2 ? c3.insertBefore(a3, b2) : c3.appendChild(a3);
        else if (4 !== d2 && (a3 = a3.child, null !== a3)) for (Wj(a3, b2, c3), a3 = a3.sibling; null !== a3; ) Wj(a3, b2, c3), a3 = a3.sibling;
      }
      var X = null;
      var Xj = false;
      function Yj(a3, b2, c3) {
        for (c3 = c3.child; null !== c3; ) Zj(a3, b2, c3), c3 = c3.sibling;
      }
      function Zj(a3, b2, c3) {
        ...
        switch (c3.tag) {
          ...
          case 14:
          case 15:
            if (!U && (d2 = c3.updateQueue, null !== d2 && (d2 = d2.lastEffect, null !== d2))) {
              e2 = d2 = d2.next;
              do {
            ...
            break;
          case 1:
            if (!U && (Lj(c3, b2), d2 = c3.stateNode, "function" === typeof d2.componentWillUnmount)) try {
          ...
          case 21:
            ...
            break;
          case 22:
            c3.mode & 1 ? (U = (d2 = U) || null !== c3.memoizedState, Yj(a3, b2, c3), U = d2) : Yj(a3, b2, c3);
            break;
          default:
            Yj(a3, b2, c3);
        }
      ...
      function ck(a3, b2) {
        var c3 = b2.deletions;
        if (null !== c3) for (var d2 = 0; d2 < c3.length; d2++) {
          var e2 = c3[d2];
          try {
      ...
      function dk(a3, b2) {
        var c3 = a3.alternate, d2 = a3.flags;
        switch (a3.tag) {
          case 0:
          case 11:
          case 14:
          ...
          case 1:
            ck(b2, a3);
            ek(a3);
            d2 & 512 && null !== c3 && Lj(c3, c3.return);
            break;
          case 5:
            ck(b2, a3);
            ek(a3);
            ...
            if (d2 & 4 && (e2 = a3.stateNode, null != e2)) {
              var f2 = a3.memoizedProps, g2 = null !== c3 ? c3.memoizedProps : f2, h2 = a3.type, k2 = a3.updateQueue;
              a3.updateQueue = null;
              if (null !== k2) try {
                ...
                for (g2 = 0; g2 < k2.length; g2 += 2) {
                  ...
                  "style" === m3 ? sb(e2, q2) : "dangerouslySetInnerHTML" === m3 ? nb(e2, q2) : "children" === m3 ? ob(e2, q2) : ta(e2, m3, q2, l2);
                }
                switch (h2) {
                  case "input":
                    bb(e2, f2);
          ...
          case 3:
            ck(b2, a3);
            ek(a3);
            if (d2 & 4 && null !== c3 && c3.memoizedState.isDehydrated) try {
              bd(b2.containerInfo);
            } catch (t3) {
              W2(a3, a3.return, t3);
            }
          ...
          case 22:
            ...
            a3.mode & 1 ? (U = (l2 = U) || m3, ck(b2, a3), U = l2) : ck(b2, a3);
            ek(a3);
            if (d2 & 8192) {
              l2 = null !== a3.memoizedState;
              if ((a3.stateNode.isHidden = l2) && !m3 && 0 !== (a3.mode & 1)) for (V2 = a3, m3 = a3.child; null !== m3; ) {
                for (q2 = V2 = m3; null !== V2; ) {
                  ...
                  null !== y3 ? (y3.return = r2, V2 = y3) : gk(q2);
                }
                m3 = m3.sibling;
              }
              a: for (m3 = null, q2 = a3; ; ) {
      ...
      function hk(a3, b2, c3) {
        V2 = a3;
        ik(a3, b2, c3);
      }
      function ik(a3, b2, c3) {
        for (var d2 = 0 !== (a3.mode & 1); null !== V2; ) {
          ...
          if (22 === e2.tag && d2) {
            ...
            if (!g2) {
              ...
              for (; null !== f2; ) V2 = f2, ik(f2, b2, c3), f2 = f2.sibling;
              V2 = e2;
              Jj = h2;
              U = l2;
            }
            kk(a3, b2, c3);
          } else 0 !== (e2.subtreeFlags & 8772) && null !== f2 ? (f2.return = e2, V2 = f2) : kk(a3, b2, c3);
        }
      }
      function kk(a3) {
        for (; null !== V2; ) {
          ...
          if (0 !== (b2.flags & 8772)) {
            ...
            try {
              if (0 !== (b2.flags & 8772)) switch (b2.tag) {
                ...
                case 1:
                  var d2 = b2.stateNode;
                  if (b2.flags & 4 && !U) if (null === c3) d2.componentDidMount();
                  else {
                    var e2 = b2.elementType === b2.type ? c3.memoizedProps : Ci(b2.type, c3.memoizedProps);
      ...
      function gi(a3, b2, c3, d2) {
        if (50 < yk) throw yk = 0, zk = null, Error(p2(185));
        Ac(a3, c3, d2);
        if (0 === (K2 & 2) || a3 !== Q2) a3 === Q2 && (0 === (K2 & 2) && (qk |= c3), 4 === T2 && Ck(a3, Z)), Dk(a3, d2), 1 === c3 && 0 === K2 && 0 === (b2.mode & 1) && (Gj = B2() + 500, fg && jg());
      }
      function Dk(a3, b2) {
        var c3 = a3.callbackNode;
        wc(a3, b2);
        var d2 = uc(a3, a3 === Q2 ? Z : 0);
        if (0 === d2) null !== c3 && bc(c3), a3.callbackNode = null, a3.callbackPriority = 0;
      ...
      function Gk(a3, b2) {
        ...
        if (0 !== (d2 & 30) || 0 !== (d2 & a3.expiredLanes) || b2) b2 = Ik(a3, d2);
          ...
          K2 |= 2;
          var f2 = Jk();
          if (Q2 !== a3 || Z !== b2) uk = null, Gj = B2() + 500, Kk(a3, b2);
          do
            try {
              Lk();
              break;
        ...
        if (0 !== b2) {
          ...
          if (1 === b2) throw c3 = pk, Kk(a3, 0), Ck(a3, d2), Dk(a3, B2()), c3;
          if (6 === b2) Ck(a3, d2);
          else {
            e2 = a3.current.alternate;
            if (0 === (d2 & 30) && !Ok(e2) && (b2 = Ik(a3, d2), 2 === b2 && (f2 = xc(a3), 0 !== f2 && (d2 = f2, b2 = Nk(a3, f2))), 1 === b2)) throw c3 = pk, Kk(a3, 0), Ck(a3, d2), Dk(a3, B2()), c3;
            a3.finishedWork = e2;
            a3.finishedLanes = d2;
            switch (b2) {
              case 0:
      ...
      function Nk(a3, b2) {
        ...
        a3 = Ik(a3, b2);
        2 !== a3 && (b2 = tk, tk = c3, null !== b2 && Fj(b2));
        return a3;
      }
      function Fj(a3) {
      ...
      function Ok(a3) {
        for (var b2 = a3; ; ) {
          if (b2.flags & 16384) {
            ...
            if (null !== c3 && (c3 = c3.stores, null !== c3)) for (var d2 = 0; d2 < c3.length; d2++) {
      ...
      function Ek(a3) {
        ...
        Hk();
        var b2 = uc(a3, 0);
        if (0 === (b2 & 1)) return Dk(a3, B2()), null;
        var c3 = Ik(a3, b2);
        if (0 !== a3.tag && 2 === c3) {
          var d2 = xc(a3);
          0 !== d2 && (b2 = d2, c3 = Nk(a3, d2));
        }
        if (1 === c3) throw c3 = pk, Kk(a3, 0), Ck(a3, b2), Dk(a3, B2()), c3;
        if (6 === c3) throw Error(p2(345));
      ...
      function Rk(a3) {
        ...
        var b2 = K2;
        K2 |= 1;
        var c3 = ok.transition, d2 = C2;
        try {
          if (ok.transition = null, C2 = 1, a3) return a3();
        } finally {
          C2 = d2, ok.transition = c3, K2 = b2, 0 === (K2 & 6) && jg();
        }
      }
      function Hj() {
        fj = ej.current;
      ...
      function Kk(a3, b2) {
        ...
        tk = sk = null;
        if (null !== fh) {
          for (b2 = 0; b2 < fh.length; b2++) if (c3 = fh[b2], d2 = c3.interleaved, null !== d2) {
            c3.interleaved = null;
      ...
      function Mk(a3, b2) {
        do {
          ...
          try {
            ...
            a: {
              var f2 = a3, g2 = c3.return, h2 = c3, k2 = b2;
              b2 = Z;
              h2.flags |= 32768;
              if (null !== k2 && "object" === typeof k2 && "function" === typeof k2.then) {
                var l2 = k2, m3 = h2, q2 = m3.tag;
      ...
      function Ik(a3, b2) {
        ...
        K2 |= 2;
        var d2 = Jk();
        if (Q2 !== a3 || Z !== b2) uk = null, Kk(a3, b2);
        do
          try {
            Tk();
            break;
      ...
      function Pk(a3, b2, c3) {
        var d2 = C2, e2 = ok.transition;
        try {
          ok.transition = null, C2 = 1, Wk(a3, b2, c3, d2);
        } finally {
          ok.transition = e2, C2 = d2;
        }
        return null;
      }
      function Wk(a3, b2, c3, d2) {
        do
          Hk();
        while (null !== wk);
        if (0 !== (K2 & 6)) throw Error(p2(327));
        ...
        a3.finishedWork = null;
        a3.finishedLanes = 0;
        if (c3 === a3.current) throw Error(p2(177));
        ...
        mc(c3.stateNode, d2);
        Dk(a3, B2());
        if (null !== b2) for (d2 = a3.onRecoverableError, c3 = 0; c3 < b2.length; c3++) e2 = b2[c3], d2(e2.value, { componentStack: e2.stack, digest: e2.digest });
      ...
      function Hk() {
        if (null !== wk) {
          var a3 = Dc(xk), b2 = ok.transition, c3 = C2;
          try {
            ok.transition = null;
            C2 = 16 > a3 ? 16 : a3;
            ...
            C2 = c3, ok.transition = b2;
          }
        }
        return false;
      }
      function Xk(a3, b2, c3) {
        b2 = Ji(c3, b2);
        b2 = Ni(a3, b2, 1);
        a3 = nh(a3, b2, 1);
        b2 = R2();
      ...
      function Ti(a3, b2, c3) {
        var d2 = a3.pingCache;
        null !== d2 && d2.delete(b2);
        b2 = R2();
        a3.pingedLanes |= a3.suspendedLanes & c3;
        Q2 === a3 && (Z & c3) === c3 && (4 === T2 || 3 === T2 && (Z & 130023424) === Z && 500 > B2() - fk ? Kk(a3, 0) : rk |= c3);
        Dk(a3, b2);
      }
      function Yk(a3, b2) {
        ...
        var c3 = R2();
        a3 = ih(a3, b2);
        null !== a3 && (Ac(a3, b2, c3), Dk(a3, c3));
      }
      function uj(a3) {
        var b2 = a3.memoizedState, c3 = 0;
      ...
      var Vk;
      Vk = function(a3, b2, c3) {
        if (null !== a3) if (a3.memoizedProps !== b2.pendingProps || Wf.current) dh = true;
        else {
          if (0 === (a3.lanes & c3) && 0 === (b2.flags & 128)) return dh = false, yj(a3, b2, c3);
        ...
        switch (b2.tag) {
          case 2:
            ...
            ch(b2, c3);
            e2 = Nh(null, b2, d2, a3, e2, c3);
            var f2 = Sh();
            b2.flags |= 1;
            "object" === typeof e2 && null !== e2 && "function" === typeof e2.render && void 0 === e2.$$typeof ? (b2.tag = 1, b2.memoizedState = null, b2.updateQueue = null, Zf(d2) ? (f2 = true, cg(b2)) : f2 = false, b2.memoizedState = null !== e2.state && void 0 !== e2.state ? e2.state : null, kh(b2), e2.updater = Ei, b2.stateNode = e2, e2._reactInternals = b2, Ii(b2, d2, a3, c3), b2 = jj(null, b2, d2, true, f2, c3)) : (b2.tag = 0, I2 && f2 && vg(b2), Xi(null, b2, e2, c3), b2 = b2.child);
            return b2;
          case 16:
            d2 = b2.elementType;
            a: {
              ...
              switch (e2) {
                case 0:
                  b2 = cj(null, b2, d2, a3, c3);
                  break a;
                case 1:
                  b2 = hj(null, b2, d2, a3, c3);
                  break a;
                case 11:
                  b2 = Yi(null, b2, d2, a3, c3);
                  break a;
                case 14:
                  b2 = $i(null, b2, d2, Ci(d2.type, a3), c3);
                  break a;
              }
              throw Error(p2(
                306,
            ...
            return b2;
          case 0:
            return d2 = b2.type, e2 = b2.pendingProps, e2 = b2.elementType === d2 ? e2 : Ci(d2, e2), cj(a3, b2, d2, e2, c3);
          case 1:
            return d2 = b2.type, e2 = b2.pendingProps, e2 = b2.elementType === d2 ? e2 : Ci(d2, e2), hj(a3, b2, d2, e2, c3);
          case 3:
            a: {
              kj(b2);
              ...
              if (f2.isDehydrated) if (f2 = { element: d2, isDehydrated: false, cache: g2.cache, pendingSuspenseBoundaries: g2.pendingSuspenseBoundaries, transitions: g2.transitions }, b2.updateQueue.baseState = f2, b2.memoizedState = f2, b2.flags & 256) {
                ...
                b2 = lj(a3, b2, d2, c3, e2);
                break a;
              } else if (d2 !== e2) {
                e2 = Ji(Error(p2(424)), b2);
                b2 = lj(a3, b2, d2, c3, e2);
                break a;
              } else for (yg = Lf(b2.stateNode.containerInfo.firstChild), xg = b2, I2 = true, zg = null, c3 = Vg(b2, null, d2, c3), b2.child = c3; c3; ) c3.flags = c3.flags & -3 | 4096, c3 = c3.sibling;
              else {
                Ig();
                if (d2 === e2) {
                  b2 = Zi(a3, b2, c3);
            ...
            return b2;
          case 5:
            return Ah(b2), null === a3 && Eg(b2), d2 = b2.type, e2 = b2.pendingProps, f2 = null !== a3 ? a3.memoizedProps : null, g2 = e2.children, Ef(d2, e2) ? g2 = null : null !== f2 && Ef(d2, f2) && (b2.flags |= 32), gj(a3, b2), Xi(a3, b2, g2, c3), b2.child;
          case 6:
            return null === a3 && Eg(b2), null;
          case 13:
            return oj(a3, b2, c3);
          case 4:
            return yh(b2, b2.stateNode.containerInfo), d2 = b2.pendingProps, null === a3 ? b2.child = Ug(b2, null, d2, c3) : Xi(a3, b2, d2, c3), b2.child;
          case 11:
            return d2 = b2.type, e2 = b2.pendingProps, e2 = b2.elementType === d2 ? e2 : Ci(d2, e2), Yi(a3, b2, d2, e2, c3);
          case 7:
            return Xi(a3, b2, b2.pendingProps, c3), b2.child;
          case 8:
            return Xi(a3, b2, b2.pendingProps.children, c3), b2.child;
          case 12:
            return Xi(a3, b2, b2.pendingProps.children, c3), b2.child;
          case 10:
            a: {
              ...
              Xi(a3, b2, e2.children, c3);
              b2 = b2.child;
            }
            return b2;
          case 9:
            return e2 = b2.type, d2 = b2.pendingProps.children, ch(b2, c3), e2 = eh(e2), d2 = d2(e2), b2.flags |= 1, Xi(a3, b2, d2, c3), b2.child;
          case 14:
            return d2 = b2.type, e2 = Ci(d2, b2.pendingProps), e2 = Ci(d2.type, e2), $i(a3, b2, d2, e2, c3);
          case 15:
            return bj(a3, b2, b2.type, b2.pendingProps, c3);
          case 17:
            return d2 = b2.type, e2 = b2.pendingProps, e2 = b2.elementType === d2 ? e2 : Ci(d2, e2), ij(a3, b2), b2.tag = 1, Zf(d2) ? (a3 = true, cg(b2)) : a3 = false, ch(b2, c3), Gi(b2, d2, e2), Ii(b2, d2, e2, c3), jj(null, b2, d2, true, a3, c3);
          case 19:
            return xj(a3, b2, c3);
          case 22:
            return dj(a3, b2, c3);
      ...
      function Bg(a3, b2, c3, d2) {
        return new $k(a3, b2, c3, d2);
      }
      function aj(a3) {
        a3 = a3.prototype;
      ...
      function Pg(a3, b2) {
        var c3 = a3.alternate;
        null === c3 ? (c3 = Bg(a3.tag, b2, a3.key, a3.mode), c3.elementType = a3.elementType, c3.type = a3.type, c3.stateNode = a3.stateNode, c3.alternate = a3, a3.alternate = c3) : (c3.pendingProps = b2, c3.type = a3.type, c3.flags = 0, c3.subtreeFlags = 0, c3.deletions = null);
      ...
      function Rg(a3, b2, c3, d2, e2, f2) {
        ...
        if ("function" === typeof a3) aj(a3) && (g2 = 1);
          ...
          case ya:
            return Tg(c3.children, e2, f2, b2);
          case za:
            g2 = 8;
            e2 |= 8;
            break;
          case Aa:
            return a3 = Bg(12, c3, b2, e2 | 2), a3.elementType = Aa, a3.lanes = f2, a3;
          case Ea:
            return a3 = Bg(13, c3, b2, e2), a3.elementType = Ea, a3.lanes = f2, a3;
          case Fa:
            return a3 = Bg(19, c3, b2, e2), a3.elementType = Fa, a3.lanes = f2, a3;
          case Ia:
            return pj(c3, e2, f2, b2);
          default:
      ...
      function Tg(a3, b2, c3, d2) {
        a3 = Bg(7, a3, d2, b2);
        a3.lanes = c3;
        return a3;
      }
      function pj(a3, b2, c3, d2) {
        a3 = Bg(22, a3, d2, b2);
        a3.elementType = Ia;
        a3.lanes = c3;
      ...
      function Qg(a3, b2, c3) {
        a3 = Bg(6, a3, null, b2);
        a3.lanes = c3;
        return a3;
      }
      function Sg(a3, b2, c3) {
      ...
      function bl(a3, b2, c3, d2, e2, f2, g2, h2, k2) {
        a3 = new al(a3, b2, c3, h2, k2);
      ...
      function cl(a3, b2, c3) {
        var d2 = 3 < arguments.length && void 0 !== arguments[3] ? arguments[3] : null;
        return { $$typeof: wa, key: null == d2 ? null : "" + d2, children: a3, containerInfo: b2, implementation: c3 };
      }
      function dl(a3) {
        if (!a3) return Vf;
        a3 = a3._reactInternals;
        ...
        if (1 === a3.tag) {
          var c3 = a3.type;
          if (Zf(c3)) return bg(a3, c3, b2);
        }
        return b2;
      }
      function el(a3, b2, c3, d2, e2, f2, g2, h2, k2) {
        a3 = bl(c3, d2, true, a3, e2, f2, g2, h2, k2);
        a3.context = dl(null);
        c3 = a3.current;
        d2 = R2();
        e2 = yi(c3);
        ...
        switch (a3.tag) {
          case 3:
            ...
            if (b2.current.memoizedState.isDehydrated) {
              ...
              0 !== c3 && (Cc(b2, c3 | 1), Dk(b2, B2()), 0 === (K2 & 6) && (Gj = B2() + 500, jg()));
            }
            break;
          case 13:
            Rk(function() {
      ...
      yb = function(a3, b2, c3) {
        switch (b2) {
          ...
          case "textarea":
            ...
            break;
          case "select":
            b2 = c3.value, null != b2 && fb(a3, !!c3.multiple, b2, false);
        }
      };
      Gb = Qk;
      Hb = Rk;
      ...
      exports.createRoot = function(a3, b2) {
        ...
        b2 = bl(a3, 1, false, null, null, c3, false, d2, e2);
        a3[uf] = b2.current;
        sf(8 === a3.nodeType ? a3.parentNode : a3);
        return new ll(b2);
      };
      ...
      exports.hydrate = function(a3, b2, c3) {
        if (!ol(b2)) throw Error(p2(200));
        return rl(null, a3, b2, true, c3);
      };
      exports.hydrateRoot = function(a3, b2, c3) {
        if (!nl(a3)) throw Error(p2(405));
        var d2 = null != c3 && c3.hydratedSources || null, e2 = false, f2 = "", g2 = kl;
        ...
        b2 = el(b2, null, a3, 1, null != c3 ? c3 : null, e2, false, f2, g2);
        a3[uf] = b2.current;
        sf(a3);
        if (d2) for (a3 = 0; a3 < d2.length; a3++) c3 = d2[a3], e2 = c3._getVersion, e2 = e2(c3._source), null == b2.mutableSourceEagerHydrationData ? b2.mutableSourceEagerHydrationData = [c3, e2] : b2.mutableSourceEagerHydrationData.push(
          c3,
          e2
        );
        return new ml(b2);
      };
      exports.render = function(a3, b2, c3) {
        if (!ol(b2)) throw Error(p2(200));
        return rl(null, a3, b2, false, c3);
      };
      ...
      exports.unstable_renderSubtreeIntoContainer = function(a3, b2, c3, d2) {
        if (!ol(c3)) throw Error(p2(200));
        if (null == a3 || void 0 === a3._reactInternals) throw Error(p2(38));
        return rl(a3, b2, c3, false, d2);
      };
    ...
    "node_modules/react-dom/client.js"(exports) {
      ...
      if (true) {
        ...
        exports.hydrateRoot = function(c3, h2, o2) {
          i2.usingClientEntryPoint = true;
          try {
            return m3.hydrateRoot(c3, h2, o2);
          } finally {
            i2.usingClientEntryPoint = false;
          }
        };
  ...
  var require_react_jsx_runtime_production_min = __commonJS({
    "node_modules/react/cjs/react-jsx-runtime.production.min.js"(exports) {
      ...
      function q2(c3, a3, g2) {
        var b2, d2 = {}, e2 = null, h2 = null;
        void 0 !== g2 && (e2 = "" + g2);
        void 0 !== a3.key && (e2 = "" + a3.key);
        void 0 !== a3.ref && (h2 = a3.ref);
        for (b2 in a3) m3.call(a3, b2) && !p2.hasOwnProperty(b2) && (d2[b2] = a3[b2]);
        if (c3 && c3.defaultProps) for (b2 in a3 = c3.defaultProps, a3) void 0 === d2[b2] && (d2[b2] = a3[b2]);
  ...
  function index(kapsuleComponent) {
    ...
    return /* @__PURE__ */ (0, import_react.forwardRef)(function(props, ref) {
      ...
      return /* @__PURE__ */ import_react.default.createElement(wrapperElementType, {
        ref: domEl
      });
    });
  }
  ...
  var render = function render2(jsx2, domEl) {
    delete domEl.__k;
    R(_reactElement2VNode(jsx2), domEl);
  };
  ...
  function link_default(links) {
    var id2 = index5, strength = defaultStrength, strengths, distance2 = constant_default5(30), distances, nodes, nDim, count, bias, random, iterations = 1;
    if (links == null) links = [];
  ...
  var FOLLOW_KEY_PREFIX = "mindtrace_followed_themes_";
  var HIGH_SIM = 0.85;
  var THIRTY_DAYS_MS = 30 * 24 * 60 * 60 * 1e3;
  var THEME_COLOR_RULES = [
    { test: (t3) => /AI|产品/.test(t3), hsl: [258, 78, 68] },
    { test: (t3) => /知识系统|知识/.test(t3), hsl: [270, 72, 66] },
    { test: (t3) => /工作流/.test(t3), hsl: [192, 78, 58] },
    { test: (t3) => /财富|商业/.test(t3), hsl: [42, 88, 62] },
    { test: (t3) => /成长|思维/.test(t3), hsl: [152, 62, 56] },
    { test: (t3) => /写作|表达/.test(t3), hsl: [328, 72, 66] }
  ];
  var FALLBACK_HUES = [220, 255, 195, 42, 155, 325];
  ...
  function openThoughtInGarden(thoughtId, gardenId) {
    ...
    const g2 = gardenId || getGardenIdFromUrl() || "garden-default";
    window.location.href = `dashboard.html?thought=${encodeURIComponent(thoughtId)}&garden=${encodeURIComponent(g2)}`;
  }
  function resolveThemeHsl(themeName, index7) {
    const t3 = themeName || "";
    ...
    const h2 = FALLBACK_HUES[index7 % FALLBACK_HUES.length];
    return [h2, 72, 64];
  }
  function hsla2(hsl2, a3) {
    const [h2, s2, l2] = hsl2;
    return `hsla(${h2}, ${s2}%, ${l2}%, ${a3})`;
  }
  function lightAngleFromId(id2) {
    let h2 = 0;
    const s2 = String(id2 || "");
    for (let i2 = 0; i2 < s2.length; i2 += 1) {
      h2 = (h2 * 31 + s2.charCodeAt(i2)) % 628;
    }
    return h2 / 100;
  }
  ...
  function drawPlanetCorona(ctx, x3, y3, r2, hsl2, alpha, intensity) {
    const layers = [
      { mul: 2.8, a: 0.06 * intensity },
      { mul: 2, a: 0.14 * intensity },
      { mul: 1.45, a: 0.22 * intensity }
    ];
    layers.forEach(({ mul, a: a3 }) => {
      const g2 = ctx.createRadialGradient(x3, y3, r2 * 0.2, x3, y3, r2 * mul);
      g2.addColorStop(0, hsla2([hsl2[0], hsl2[1] - 4, Math.min(92, hsl2[2] + 22)], a3 * alpha));
      g2.addColorStop(0.45, hsla2(hsl2, a3 * 0.65 * alpha));
      g2.addColorStop(1, hsla2([hsl2[0], hsl2[1], hsl2[2]], 0));
      ctx.beginPath();
      ctx.arc(x3, y3, r2 * mul, 0, 2 * Math.PI);
      ctx.fillStyle = g2;
      ctx.fill();
    });
  }
  function drawPlanetSphere(ctx, x3, y3, r2, hsl2, alpha, nodeId, hub) {
    const la = lightAngleFromId(nodeId);
    const lx = x3 + Math.cos(la) * r2 * 0.38;
    const ly = y3 + Math.sin(la) * r2 * 0.38 - r2 * 0.08;
    const body = ctx.createRadialGradient(lx, ly, r2 * 0.05, x3, y3, r2 * 1.05);
    body.addColorStop(0, hsla2([hsl2[0], Math.min(95, hsl2[1] + 8), Math.min(88, hsl2[2] + 28)], 0.98 * alpha));
    body.addColorStop(0.35, hsla2([hsl2[0], hsl2[1], Math.min(72, hsl2[2] + 8)], 0.95 * alpha));
    body.addColorStop(0.72, hsla2(hsl2, 0.9 * alpha));
    body.addColorStop(1, hsla2([hsl2[0], hsl2[1] - 6, Math.max(18, hsl2[2] - 32)], alpha));
    ctx.beginPath();
    ctx.arc(x3, y3, r2, 0, 2 * Math.PI);
    ctx.fillStyle = body;
    ctx.fill();
    const term = ctx.createRadialGradient(
      x3 - Math.cos(la) * r2 * 0.5,
      y3 - Math.sin(la) * r2 * 0.5,
      r2 * 0.1,
      x3,
      y3,
      r2
    ...
    ctx.fill();
    ctx.save();
    ctx.shadowBlur = hub ? r2 * 0.35 : r2 * 0.22;
    ctx.shadowColor = hsla2([hsl2[0], hsl2[1], Math.min(90, hsl2[2] + 18)], 0.75 * alpha);
    ctx.strokeStyle = hsla2([hsl2[0], Math.min(92, hsl2[1] + 12), Math.min(88, hsl2[2] + 24)], 0.55 * alpha);
    ctx.lineWidth = Math.max(0.6, hub ? 1.8 : 1.1);
    ctx.beginPath();
    ctx.arc(x3, y3, r2 * 0.98, 0, 2 * Math.PI);
    ctx.stroke();
    ctx.restore();
    const spec = ctx.createRadialGradient(lx, ly, 0, lx, ly, r2 * 0.55);
    spec.addColorStop(0, `rgba(255, 255, 255, ${(hub ? 0.55 : 0.38) * alpha})`);
    spec.addColorStop(0.35, hsla2([hsl2[0], 40, 92], 0.12 * alpha));
    spec.addColorStop(1, "rgba(255,255,255,0)");
    ctx.beginPath();
    ctx.arc(lx, ly, r2 * (hub ? 0.42 : 0.32), 0, 2 * Math.PI);
    ctx.fillStyle = spec;
    ctx.fill();
  }
  function drawRecordDot(ctx, node, hsl2, alpha, active) {
    const r2 = node.radius || GALAXY.thoughtR;
    node.moonR = r2;
    node.radius = r2;
    if (active) {
      drawPlanetCorona(ctx, node.x, node.y, r2 * 2.2, hsl2, alpha, 1.4);
    }
    drawPlanetCorona(ctx, node.x, node.y, r2 * 1.4, hsl2, alpha, 0.75);
    ...
    body.addColorStop(0.45, hsla2([hsl2[0], hsl2[1], Math.min(88, hsl2[2] + 18)], 0.9 * alpha));
    body.addColorStop(1, hsla2([hsl2[0], hsl2[1], hsl2[2]], 0.5 * alpha));
    ctx.save();
    ctx.shadowBlur = active ? r2 * 3 : r2 * 2;
    ctx.shadowColor = hsla2(hsl2, 0.85 * alpha);
    ctx.beginPath();
  ...
  function paintEnergyFlow(ctx, s2, t3, hsl2, dim, globalScale, curvature, strength) {
    const p1 = surfacePoint(s2, t3.x, t3.y);
    const p2 = surfacePoint(t3, s2.x, s2.y);
    const dx = p2.x - p1.x;
    const dy = p2.y - p1.y;
    const dist = Math.hypot(dx, dy) || 1;
    ...
    ctx.lineJoin = "round";
    drawPath();
    ctx.strokeStyle = hsla2([hsl2[0], hsl2[1], Math.min(75, hsl2[2] + 8)], 0.08 * dim);
    ctx.lineWidth = glowW * 2.2;
    ctx.shadowBlur = glowW * 3;
    ctx.shadowColor = hsla2(hsl2, 0.45 * dim);
    ctx.stroke();
    drawPath();
    const beam = ctx.createLinearGradient(p1.x, p1.y, p2.x, p2.y);
    beam.addColorStop(0, hsla2([hsl2[0], hsl2[1], Math.min(85, hsl2[2] + 20)], 0.05 * dim));
    beam.addColorStop(0.35, hsla2(hsl2, 0.35 * dim));
    beam.addColorStop(0.65, hsla2([hsl2[0], Math.min(95, hsl2[1] + 10), Math.min(88, hsl2[2] + 16)], 0.5 * dim));
    beam.addColorStop(1, hsla2([hsl2[0], hsl2[1], hsl2[2]], 0.12 * dim));
    ctx.strokeStyle = beam;
    ctx.lineWidth = glowW;
    ctx.shadowBlur = glowW * 1.2;
    ctx.shadowColor = hsla2(hsl2, 0.35 * dim);
    ctx.stroke();
    drawPath();
    ctx.shadowBlur = coreW * 4;
    ctx.shadowColor = `rgba(200, 230, 255, ${0.7 * dim})`;
    ctx.strokeStyle = hsla2([hsl2[0], Math.min(98, hsl2[1] + 15), Math.min(92, hsl2[2] + 26)], 0.75 * dim);
    ctx.lineWidth = coreW;
    ctx.stroke();
    ctx.restore();
  }
  ...
  function splitLinesForCircle(text, maxChars, maxLines) {
    const t3 = (text || "").trim() || "\u601D\u8003";
    if (t3.length <= maxChars) {
      return [t3];
    }
    const parts = t3.split(/[·•]/).map((s2) => s2.trim()).filter(Boolean);
    if (parts.length >= 2) {
      return parts.slice(0, maxLines).map(
        (p2) => p2.length > maxChars ? `${p2.slice(0, maxChars - 1)}\u2026` : p2
      );
    }
    const lines = [];
    for (let i2 = 0; i2 < t3.length && lines.length < maxLines; i2 += maxChars) {
      lines.push(t3.slice(i2, i2 + maxChars) + (i2 + maxChars < t3.length ? "\u2026" : ""));
    }
    return lines;
  }
  function drawInsideCircle(ctx, lines, x3, y3, radius, fontSize, alpha, hsl2) {
    const lh = fontSize * 1.22;
    const startY = y3 - (lines.length - 1) * lh / 2;
    ctx.save();
    ctx.beginPath();
    ctx.arc(x3, y3, radius * 0.88, 0, 2 * Math.PI);
    ctx.clip();
    ...
    lines.forEach((line, i2) => {
      ...
      ctx.shadowBlur = 6;
      ctx.shadowColor = hsla2(hsl2 || [220, 70, 70], 0.7 * alpha);
      ctx.fillStyle = `rgba(248, 252, 255, ${0.96 * alpha})`;
      ctx.fillText(line, x3, startY + i2 * lh);
    });
    ctx.restore();
  }
  ...
  function computeNetworkDensity(thoughtCount, linkCount) {
    ...
    const max3 = thoughtCount * (thoughtCount - 1) / 2;
    return max3 > 0 ? Math.round(linkCount / max3 * 100) / 100 : 0;
  }
  function layoutThemesOnlyRing(themeNodes, cx, cy) {
    const n2 = themeNodes.length;
    const ringR = clusterRingRadius(cx, cy) * 0.85;
    themeNodes.forEach((theme, i2) => {
      const angle = i2 / Math.max(1, n2) * Math.PI * 2 - Math.PI / 2;
      ...
      theme.clusterHsl = GALAXY.clusterHsl[i2 % GALAXY.clusterHsl.length];
    });
    return themeNodes;
  }
  function layoutSatelliteRing(sub, satellites, subIndex, subTotal, hubCx, hubCy) {
    const n2 = satellites.length;
    if (!n2) {
      return;
    }
    const outward = Math.atan2(sub.y - hubCy, sub.x - hubCx);
    const orbitR = GALAXY.satelliteOrbit + Math.min(22, n2 * 2.5) + (subTotal > 4 ? subIndex % 3 * 6 : 0);
    const phase = outward + subIndex / Math.max(1, subTotal) * 0.35;
    satellites.forEach((sat, idx) => {
      const angle = n2 === 1 ? phase + Math.PI / 2 : phase + idx / n2 * Math.PI * 2;
  ...
  function layoutGalaxySystem(hubTheme, subNodes, thoughtNodes, cx, cy) {
    ...
    subNodes.forEach((sub, i2) => {
      const angle = i2 / Math.max(1, subN) * Math.PI * 2 - Math.PI / 2;
      ...
      sub.fx = sub.x;
      sub.fy = sub.y;
      sub.clusterHsl = GALAXY.clusterHsl[i2 % GALAXY.clusterHsl.length];
    });
    subNodes.forEach((sub, subIndex) => {
      const ids = new Set(sub.recordIds || []);
      const satellites = thoughtNodes.filter((t3) => ids.has(t3.id));
      satellites.forEach((n2) => {
        n2.subClusterId = sub.id;
        n2.parentThemeId = hubTheme.clusterId;
        n2.clusterHsl = sub.clusterHsl;
      });
  ...
  function pinAllNodes(nodes) {
    nodes.forEach((n2) => {
      if (Number.isFinite(n2.x) && Number.isFinite(n2.y)) {
        n2.fx = n2.x;
        n2.fy = n2.y;
      }
    });
  ...
  function buildThoughtNodes(thoughts, meta) {
    const themeNameMap = new Map(meta.map((m3) => [m3.clusterId, m3.theme]));
    const assign = typeof MindTraceThemeGalaxyService !== "undefined" && typeof MindTraceThemeGalaxyService.assignThemeId === "function" ? MindTraceThemeGalaxyService.assignThemeId.bind(MindTraceThemeGalaxyService) : () => "theme-misc";
    return thoughts.map((t3) => {
      const themeId = assign(t3);
      const label = MindTraceGraphService.extractLabel(t3);
      return {
        id: t3.id,
        nodeType: "thought",
        label,
  ...
  function buildSubClusterNodes(themeId, members, semanticLinks) {
    if (typeof MindTraceThemeGalaxyService === "undefined" || typeof MindTraceThemeGalaxyService.buildSubClustersForTheme !== "function") {
      return [];
    }
  ...
  function buildUniverseData(thoughts, meta, thoughtById, semanticLinks, cx, cy, focusThemeId) {
    const themeNodes = meta.map((m3) => ({
      id: `theme:${m3.clusterId}`,
      nodeType: "theme",
      label: m3.theme,
      clusterId: m3.clusterId,
      count: m3.count,
      recordIds: m3.recordIds || [],
      description: m3.description,
      val: NODE_RADIUS.themeHub * 2,
      x: cx,
      y: cy
    }));
    const themeLinks = typeof MindTraceThemeGalaxyService !== "undefined" ? MindTraceThemeGalaxyService.buildThemeLinks(meta, semanticLinks) : [];
    if (!focusThemeId) {
      const nodes2 = layoutThemesOnlyRing(themeNodes, cx, cy);
      pinAllNodes(nodes2);
      return {
        nodes: nodes2,
        links: themeLinks.map((l2) => ({ ...l2, linkType: "theme" })),
        thoughtCount: thoughts.length,
        themeCount: themeNodes.length,
        hubId: null
      };
    }
    const focusMeta = meta.find((m3) => m3.clusterId === focusThemeId);
    const hubTheme = themeNodes.find((t3) => t3.clusterId === focusThemeId);
    const members = (focusMeta?.recordIds || []).map((id2) => thoughtById.get(id2)).filter(Boolean);
    ...
    subNodes.forEach((s2) => {
      (s2.recordIds || []).forEach((id2) => subIds.add(id2));
    });
    const allThoughtNodes = buildThoughtNodes(thoughts, meta);
    const thoughtNodes = allThoughtNodes.filter(
      (n2) => n2.themeId === focusThemeId && subIds.has(n2.id)
    );
    const nodes = layoutGalaxySystem(hubTheme, subNodes, thoughtNodes, cx, cy);
    pinAllNodes(nodes);
    const recordToSub = /* @__PURE__ */ new Map();
    subNodes.forEach((s2) => {
      (s2.recordIds || []).forEach((rid) => recordToSub.set(rid, s2.id));
    });
    const themeSubLinks = subNodes.map((s2) => ({
      source: hubTheme.id,
      target: s2.id,
      similarity: 0.7,
      linkType: "theme-sub"
    }));
    const subThoughtLinks = thoughtNodes.map((n2) => ({
      source: recordToSub.get(n2.id),
      target: n2.id,
      similarity: 0.6,
  ...
  function CosmosGraph({
    ...
    const fgRef = (0, import_react2.useRef)(null);
    const loadRef = (0, import_react2.useRef)({
      thoughts: [],
      meta: [],
      thoughtById: /* @__PURE__ */ new Map(),
      semanticLinks: []
    });
    const [size, setSize] = (0, import_react2.useState)({ w: 600, h: 400 });
    const [graphData, setGraphData] = (0, import_react2.useState)({ nodes: [], links: [] });
    const [status, setStatus] = (0, import_react2.useState)("loading");
    const [statusDetail, setStatusDetail] = (0, import_react2.useState)("\u6B63\u5728\u8F7D\u5165\u601D\u8003\u2026");
    const resize = (0, import_react2.useCallback)(() => {
    ...
    (0, import_react2.useEffect)(() => {
      ...
      async function loadGraph() {
        ...
        try {
          const resolvedGarden = gardenId || (typeof MindTraceGardenService !== "undefined" ? await MindTraceGardenService.getCurrentGardenId() : null);
          const thoughts = resolvedGarden ? await MindTraceStorage.getAll(resolvedGarden) : await MindTraceStorage.getAllRaw();
          if (!thoughts.length) {
            if (!cancelled) {
              setGraphData({ nodes: [], links: [] });
              setStatus("empty");
              setStatusDetail("\u8FD8\u6CA1\u6709\u8BB0\u5F55\uFF0C\u53BB\u7F51\u9875\u5212\u8BCD\u6216\u6309 Alt+Shift+N \u7A7A\u767D\u901F\u8BB0\u5427");
              onDataLoaded({ thoughts: [], meta: [], metrics: null, thoughtById: /* @__PURE__ */ new Map() });
            }
            return;
          }
          const graphRaw = MindTraceGraphService.buildGraph(thoughts);
          const semanticLinks = graphRaw.links || [];
          const thoughtById = new Map(thoughts.map((t3) => [t3.id, t3]));
          const rect = containerRef.current?.getBoundingClientRect();
          const cx = rect ? rect.width / 2 : 400;
          const cy = rect ? rect.height / 2 : 300;
          const meta = typeof MindTraceThemeGalaxyService !== "undefined" && typeof MindTraceThemeGalaxyService.buildThemeMeta === "function" ? MindTraceThemeGalaxyService.buildThemeMeta(thoughts) : [];
          ...
          if (!cancelled) {
            ...
            onDataLoaded({
              ...
              thoughtById,
              semanticLinks,
              themeByCluster: new Map(meta.map((m3, i2) => [m3.clusterId, { ...m3, colorIndex: i2 }]))
            });
          }
        } catch (err) {
      ...
      try {
        ...
        window.setTimeout(() => {
          try {
            ...
            } else if (typeof fg.zoomToFit === "function" && graphData.nodes.length > 0) {
              fg.zoomToFit(280, 48);
            }
          } catch (e2) {
            console.warn("[MindTrace Graph] zoom:", e2);
          }
        }, 80);
      } catch (err) {
    ...
    const nodeById = (0, import_react2.useMemo)(() => {
    ...
    const themeColorIndex = (0, import_react2.useMemo)(() => {
      const m3 = /* @__PURE__ */ new Map();
      graphData.nodes.filter((n2) => n2.nodeType === "theme").forEach((n2, i2) => m3.set(n2.clusterId, i2));
      return m3;
    }, [graphData.nodes]);
    const nodeAlpha = (0, import_react2.useCallback)(
      (node) => {
        if (!selectedClusterId) {
          return 1;
        }
        const tid = node.parentThemeId || node.themeId || node.clusterId;
        if (node.nodeType === "theme" && node.clusterId === selectedClusterId) {
          return 1;
        }
    ...
    const paintNode = (0, import_react2.useCallback)(
      (node, ctx, globalScale) => {
        ...
        const parentThemeId = node.parentThemeId || node.themeId || node.clusterId;
        const colorIdx = themeColorIndex.get(parentThemeId) ?? 0;
        const parentMeta = graphData.nodes.find(
          (n2) => n2.nodeType === "theme" && n2.clusterId === parentThemeId
        );
        const hsl2 = node.clusterHsl || (node.isHub ? GALAXY.hubHsl : resolveThemeHsl(
          isTheme ? node.label : parentMeta?.label || node.clusterLabel,
          colorIdx
        ));
        const r2 = node.radius || nodeRadiusFor(node);
        const active = highlightId === node.id || hoveredId === node.id;
        if (isThought) {
          drawRecordDot(ctx, node, hsl2, alpha, active);
          return;
        }
        const coronaBoost = node.isHub ? 1.45 : isSub ? 1.12 : active ? 1.18 : 0.95;
        drawPlanetCorona(ctx, node.x, node.y, r2, hsl2, alpha, coronaBoost);
        drawPlanetSphere(ctx, node.x, node.y, r2, hsl2, alpha, node.id, node.isHub);
        if (isTheme || isSub) {
          ...
          drawInsideCircle(ctx, lines, node.x, node.y, r2, fontSize, alpha, hsl2);
        }
        if (active) {
          drawPlanetCorona(ctx, node.x, node.y, r2 + 8 / globalScale, hsl2, alpha, 1.5);
        }
      },
      [highlightId, hoveredId, nodeAlpha, themeColorIndex, graphData.nodes]
    );
    const paintLink = (0, import_react2.useCallback)(
      (link, ctx, globalScale) => {
        const s2 = typeof link.source === "object" ? link.source : nodeById.get(link.source);
        const t3 = typeof link.target === "object" ? link.target : nodeById.get(link.target);
        if (!s2 || !t3 || !isNodePlaced(s2) || !isNodePlaced(t3)) {
          return;
        }
        const dim = Math.min(nodeAlpha(s2), nodeAlpha(t3));
        const themeKey = s2.parentThemeId || s2.themeId || s2.clusterId || t3.parentThemeId || t3.themeId || t3.clusterId;
        const colorIdx = themeColorIndex.get(themeKey) ?? 0;
        const hubNode = graphData.nodes.find(
          (n2) => n2.nodeType === "theme" && n2.clusterId === themeKey
        );
        const hsl2 = resolveThemeHsl(hubNode?.label || s2.clusterLabel, colorIdx);
        if (link.linkType === "theme") {
          paintEnergyFlow(ctx, s2, t3, hsl2, dim, globalScale, 0.1, 0.85);
          return;
        }
        if (link.linkType === "theme-sub") {
          paintEnergyFlow(ctx, s2, t3, hsl2, dim, globalScale, 0.05, 0.72);
          return;
        }
        if (link.linkType === "sub-thought") {
          paintEnergyFlow(ctx, s2, t3, hsl2, dim * 0.9, globalScale, 0.04, 0.48);
          return;
        }
        const sim = link.similarity || 0.78;
        const strong = sim >= HIGH_SIM;
        paintEnergyFlow(ctx, s2, t3, hsl2, dim, globalScale, 0.1, strong ? 0.9 : 0.55);
      },
      [nodeById, nodeAlpha, themeColorIndex, graphData.nodes]
    );
    const linkWidth = (0, import_react2.useCallback)((link) => {
      if (link.linkType === "theme-sub" || link.linkType === "sub-thought") {
        return 0.5;
      }
      const sim = link.similarity || 0.78;
      const t3 = Math.min(1, Math.max(0, (sim - 0.78) / 0.22));
      return 0.35 + t3 * 2.8;
    }, []);
    const linkColor = (0, import_react2.useCallback)(
      (link) => {
        ...
        const s2 = nodeById.get(sId);
        const t3 = nodeById.get(tId);
        if (selectedClusterId && s2 && t3 && (s2.cluster !== selectedClusterId || t3.cluster !== selectedClusterId)) {
          return "rgba(60, 80, 120, 0.05)";
        }
        const sim = link.similarity || 0.78;
        const strong = sim >= HIGH_SIM;
        const alpha = strong ? 0.35 + (sim - HIGH_SIM) / 0.15 * 0.35 : 0.06 + (sim - 0.78) / 0.22 * 0.18;
        return strong ? `rgba(150, 170, 255, ${Math.min(0.75, alpha)})` : `rgba(100, 130, 200, ${Math.min(0.35, alpha)})`;
      },
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-stage", ref: containerRef, children: [
      status === "ready" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ForceGraph2D,
        {
          ...
          nodeVal: "val",
          nodeLabel: (n2) => {
            if (n2.nodeType === "thought") {
              return (n2.label || n2.name || "").trim() || "\u601D\u8003";
            }
            if (n2.nodeType === "theme") {
              return `${n2.label}
${n2.count || 0} \u6761\u8BB0\u5F55`;
            }
            if (n2.nodeType === "subcluster") {
              return `${n2.label}
${n2.count || 0} \u6761\u8BB0\u5F55`;
            }
            return "";
          ...
          nodePointerAreaPaint: (node, color2, ctx) => {
            ...
            const r2 = nodeRadiusFor(node) * 1.2;
            ctx.beginPath();
            ctx.arc(node.x, node.y, r2, 0, 2 * Math.PI);
            ctx.fillStyle = color2;
            ctx.fill();
          ...
          onNodeHover: (n2) => setHoveredId(n2 ? n2.id : null),
          onBackgroundClick: () => onSelectThought(null)
        }
      ),
      (status === "loading" || status === "empty" || status === "error") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-overlay", "aria-live": "polite", children: [
        status === "loading" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-spinner" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-overlay-card", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-overlay-title", children: status === "empty" ? "\u8FD9\u7247\u5B87\u5B99\u8FD8\u662F\u7A7A\u7684" : status === "error" ? "\u52A0\u8F7D\u9047\u5230\u95EE\u9898" : "\u6B63\u5728\u51C6\u5907\u56FE\u8C31" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-overlay-text", children: statusDetail }),
          (status === "empty" || status === "error") && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: "dashboard.html", className: "cosmos-overlay-btn", children: "\u56DE\u5230\u601D\u7EF4\u82B1\u56ED" })
        ] })
      ] })
    ] });
  }
  function ThemeSidebar({
    ...
    const filtered = meta.filter(
      (m3) => q2 ? (m3.theme || "").toLowerCase().includes(q2) : true
    );
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", { className: "cosmos-sidebar", "aria-label": "\u4E3B\u9898\u661F\u7CFB", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-sidebar-head", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "cosmos-sidebar-title", children: "\u4E3B\u9898\u661F\u7CFB" }),
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-theme-list", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-theme-name", children: "\u5168\u90E8" }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-theme-count", children: totalThoughts })
            ]
          }
        ),
        filtered.map((m3, i2) => {
          const hsl2 = resolveThemeHsl(m3.theme, i2);
          return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              type: "button",
              className: `cosmos-theme-item${selectedClusterId === m3.clusterId ? " is-active" : ""}`,
              onClick: () => onSelectCluster(m3.clusterId),
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "span",
                  {
                    className: "cosmos-theme-dot",
                    style: { background: hsla2(hsl2, 0.95) }
                  }
                ),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-theme-name", children: m3.theme }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-theme-count", children: m3.count })
              ]
            },
            m3.clusterId
          );
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-sidebar-foot", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "button",
        {
          type: "button",
  ...
  function DetailPanel({
    ...
    const [followed, setFollowed] = (0, import_react2.useState)(() => /* @__PURE__ */ new Set());
    ...
    const toggleFollow = (0, import_react2.useCallback)(() => {
      if (!selectedClusterId) {
        return;
      }
    ...
    const getRelated = (0, import_react2.useMemo)(() => {
      if (!meta?.length) {
        return () => [];
      }
      if (typeof MindTraceThemeGalaxyService !== "undefined" && typeof MindTraceThemeGalaxyService.buildThemeRelations === "function") {
    ...
    if (!selectedClusterId) {
      ...
      return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-detail-inner", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-detail-tag", children: "\u601D\u7EF4\u5B87\u5B99" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { className: "cosmos-detail-title", children: "\u5168\u90E8\u4E3B\u9898\u661F\u7CFB" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "cosmos-detail-stats", children: [
          meta?.length || 0,
          " \u4E2A\u4E3B\u9898 \xB7 ",
          total,
          " \u6761\u601D\u8003"
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-detail-desc", children: "\u8FD9\u662F\u4F60\u7684\u601D\u7EF4\u7ED3\u6784\u9E1F\u77B0\u3002\u70B9\u9009\u5DE6\u4FA7\u67D0\u4E00\u4E3B\u9898\uFF0C\u6216\u70B9\u51FB\u56FE\u8C31\u4E2D\u7684\u4E3B\u9898\u5927\u5706\uFF0C\u67E5\u770B\u8BE5\u65B9\u5411\u4E0A\u7684\u601D\u8003\u4E0E\u4E3B\u9898\u4E4B\u95F4\u7684\u5173\u8054\u3002" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-detail-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "cosmos-detail-section-title", children: "\u4E3B\u9898\u4E00\u89C8" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "cosmos-thought-list", children: (meta || []).map((m3, i2) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              type: "button",
              className: "cosmos-thought-item",
              onClick: () => onSelectCluster && onSelectCluster(m3.clusterId),
              children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "cosmos-thought-item-title", children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                  "span",
                  {
                    className: "cosmos-thought-bullet",
                    style: {
                      background: hsla2(resolveThemeHsl(m3.theme, i2), 0.9)
                    }
                  }
                ),
                m3.theme,
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-theme-count-inline", children: m3.count })
              ] })
            }
          ) }, m3.clusterId)) })
        ] })
    ...
    const cluster = meta?.find((m3) => m3.clusterId === selectedClusterId);
    if (!cluster) {
      return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-detail-inner", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-detail-empty", children: "\u9009\u62E9\u5DE6\u4FA7\u4E3B\u9898\u6216\u70B9\u51FB\u56FE\u8C31\u4E2D\u7684\u8282\u70B9\uFF0C\u67E5\u770B\u4F60\u7684\u60F3\u6CD5\u5982\u4F55\u5F7C\u6B64\u8FDE\u63A5\u3002" }) });
    }
    const idx = meta.findIndex((m3) => m3.clusterId === cluster.clusterId);
    const hsl2 = resolveThemeHsl(cluster.theme, idx);
    const members = (cluster.recordIds || []).map((id2) => thoughtById.get(id2)).filter(Boolean).sort((a3, b2) => (b2.createdAt || 0) - (a3.createdAt || 0));
    const lastUpdated = members[0]?.createdAt;
    const related = getRelated(cluster.clusterId);
    const topStrength = related[0]?.score || (members.length > 1 ? 0.72 : 0.45);
    const dashboardFilterUrl = `dashboard.html?garden=${encodeURIComponent(gid)}`;
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-detail-inner", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "cosmos-detail-tag", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "span",
            {
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", { className: "cosmos-detail-title", children: [
          cluster.theme,
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-detail-badge", children: "\u4E3B\u9898\u661F\u7CFB" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "cosmos-detail-stats", children: [
          cluster.count,
          " \u4E2A\u76F8\u5173\u601D\u8003",
          lastUpdated ? ` \xB7 \u66F4\u65B0\u4E8E ${formatNodeDate(lastUpdated)}` : ""
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-detail-desc", children: cluster.description || themeDescription(cluster.theme) }),
        cluster.keywords && cluster.keywords.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-detail-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "cosmos-detail-section-title", children: "\u5173\u952E\u8BCD" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-keywords", children: cluster.keywords.map((kw) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-keyword-pill", children: kw }, kw)) })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-detail-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "cosmos-detail-section-title", children: "\u5173\u8054\u5F3A\u5EA6" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-strength-bar", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "div",
            {
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-strength-label", children: strengthLabel(topStrength) })
        ] }),
        related.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-detail-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "cosmos-detail-section-title", children: "\u5173\u8054\u6700\u5F3A\u4E3B\u9898" }),
          related.map((r2) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-related-item", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: r2.theme }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "cosmos-related-score", children: [
              "\u76F8\u5173\u5EA6 ",
              r2.score.toFixed(2)
            ] })
          ] }, r2.clusterId))
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-detail-section", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "cosmos-detail-section-title", children: "\u6700\u8FD1\u601D\u8003" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", { className: "cosmos-thought-list", children: members.slice(0, 5).map((t3) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
            "button",
            {
              type: "button",
              className: `cosmos-thought-item${highlightId === t3.id ? " is-active" : ""}`,
              onClick: () => {
                if (onSelectThought) {
                  onSelectThought(t3.id);
                }
              },
              onDoubleClick: () => openThoughtInGarden(t3.id, gardenId),
              children: [
                /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { className: "cosmos-thought-item-title", children: [
                  /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                    "span",
                    {
                      className: "cosmos-thought-bullet",
                      style: { background: hsla2(hsl2, 0.9) }
                    }
                  ),
                  MindTraceGraphService.extractLabel(t3)
                ] }),
                /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-thought-item-date", children: formatNodeDate(t3.createdAt) })
              ]
            }
          ) }, t3.id)) })
        ] })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-detail-actions", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: dashboardFilterUrl, className: "cosmos-btn cosmos-btn--primary", children: "\u67E5\u770B\u5168\u90E8\u8BB0\u5F55 \u2192" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            type: "button",
            className: `cosmos-btn cosmos-btn--ghost cosmos-btn--follow${followed.has(cluster.clusterId) ? " is-followed" : ""}`,
            onClick: toggleFollow,
            children: followed.has(cluster.clusterId) ? "\u2605 \u5DF2\u5173\u6CE8\u4E3B\u9898" : "\u2606 \u8BBE\u4E3A\u5173\u6CE8\u4E3B\u9898"
          }
        )
      ] })
    ] });
  ...
  function App() {
    const gardenId = (0, import_react2.useMemo)(() => getGardenIdFromUrl(), []);
    const [gardenLabel, setGardenLabel] = (0, import_react2.useState)("");
    const [search, setSearch] = (0, import_react2.useState)("");
    const [selectedClusterId, setSelectedClusterId] = (0, import_react2.useState)(null);
    const [highlightId, setHighlightId] = (0, import_react2.useState)(null);
    ...
    (0, import_react2.useEffect)(() => {
      ...
      async function loadLabel() {
        ...
        try {
          const id2 = gardenId || await MindTraceGardenService.getCurrentGardenId();
          const gardens = await MindTraceGardenService.getGardens();
          const g2 = gardens.find((item) => item.id === id2);
          if (!cancelled) {
            setGardenLabel(g2 ? g2.name : "");
          }
        } catch {
        }
      }
    ...
    const handleExport = (0, import_react2.useCallback)(() => {
      ...
      a3.download = `mindtrace-cosmos-${Date.now()}.json`;
      a3.click();
    ...
    const dashboardHref = gardenId ? `dashboard.html?garden=${encodeURIComponent(gardenId)}` : "dashboard.html";
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-app", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("header", { className: "cosmos-header", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-header-brand", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "cosmos-header-icon", "aria-hidden": "true", children: "\u{1F30C}" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "cosmos-title", children: "\u601D\u7EF4\u5B87\u5B99" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-sub", children: gardenLabel ? `\u5F53\u524D\u82B1\u56ED\uFF1A${gardenLabel} \xB7 \u53D1\u73B0\u60F3\u6CD5\u4E4B\u95F4\u9690\u85CF\u7684\u8054\u7CFB` : "\u53D1\u73B0\u60F3\u6CD5\u4E4B\u95F4\u9690\u85CF\u7684\u8054\u7CFB" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-header-actions", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: dashboardHref, className: "cosmos-btn", children: "\u2190 \u8FD4\u56DE\u601D\u7EF4\u82B1\u56ED" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              type: "button",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-body-grid", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          ThemeSidebar,
          {
            meta: payload.meta,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { className: "cosmos-center", "aria-label": "\u5B87\u5B99\u56FE\u8C31", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-map-vignette", "aria-hidden": "true" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-nebula", "aria-hidden": "true" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-stars", "aria-hidden": "true" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-dust", "aria-hidden": "true" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-metrics", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-metric", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-metric-value", children: metrics.thoughts }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-metric-label", children: "\u601D\u8003\u8282\u70B9" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-metric", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-metric-value", children: metrics.links }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-metric-label", children: "\u5173\u8054\u5173\u7CFB" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-metric", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-metric-value", children: metrics.themes }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-metric-label", children: "\u4E3B\u9898\u6570\u91CF" })
            ] }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-metric", children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-metric-value", children: metrics.density.toFixed(2) }),
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "cosmos-metric-label", children: "\u7F51\u7EDC\u5BC6\u5EA6" })
            ] })
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-graph-wrap", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
              CosmosGraph,
              {
                selectedClusterId,
            ...
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-graph-hint", children: "\u4E2D\u5FC3\u4E3B\u9898 \u2192 \u4E3B\u9898\u7C07 \u2192 \u8BB0\u5F55 \xB7 \u62D6\u52A8\u5E73\u79FB \xB7 \u6EDA\u8F6E\u7F29\u653E \xB7 \u60AC\u505C\u8BB0\u5F55\u770B\u5168\u6587" })
          ] })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("aside", { className: "cosmos-detail", "aria-label": "\u4E3B\u9898\u8BE6\u60C5", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          DetailPanel,
          {
            selectedClusterId,
            highlightId,
  ...
  window.addEventListener("error", (e2) => {
    if (!e2.filename || e2.filename.indexOf("graph.bundle") === -1) {
      return;
    }
    showGraphBootError(
