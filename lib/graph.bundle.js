(() => {
  ...
  var BG = "#050816";
  var CLUSTER_HUES = [210, 255, 280, 195, 240, 265, 225];
  var GUIDE_DISMISS_KEY = "mindtrace_cosmos_guide_dismissed";
  ...
  function clusterHue(clusterId) {
    const m3 = /cluster-(\d+)/.exec(clusterId || "");
    const idx = m3 ? parseInt(m3[1], 10) : 0;
  ...
  function CosmosGraph() {
    ...
    const [size, setSize] = (0, import_react2.useState)({ w: 800, h: 600 });
    ...
    const [guideOpen, setGuideOpen] = (0, import_react2.useState)(() => {
      try {
    ...
    (0, import_react2.useEffect)(() => {
      ...
      async function loadGraph() {
        ...
        try {
          ...
          const thoughts = resolvedGarden ? await MindTraceStorage.getAllForGarden(resolvedGarden) : await MindTraceStorage.getAllRaw();
          if (!thoughts.length) {
            if (!cancelled) {
          ...
          const nodes = raw.nodes.map((n2, index7, arr) => {
            const angle = index7 / Math.max(1, arr.length) * Math.PI * 2;
            return {
              ...n2,
              val: n2.weight,
              name: n2.label,
          ...
          const links = raw.links.map((l2) => ({ ...l2 }));
          if (!cancelled) {
            setGraphData({ nodes, links });
    ...
    const paintNode = (0, import_react2.useCallback)(
      (node, ctx, globalScale) => {
        ...
        const r2 = nodeRadius(node) / globalScale;
        ...
        ctx.beginPath();
        ctx.arc(node.x, node.y, r2 * 0.42, 0, 2 * Math.PI, false);
        ctx.fillStyle = core;
        ctx.fill();
        if (highlightId === node.id) {
          ...
          ctx.beginPath();
          ctx.arc(node.x, node.y, r2 * 1.15, 0, 2 * Math.PI, false);
          ctx.stroke();
        }
      },
      [highlightId]
    ...
    const linkColor = (0, import_react2.useCallback)((link) => {
      const sim = link.similarity || 0.78;
    ...
    const selectedNode = (0, import_react2.useMemo)(() => {
      ...
      return graphData.nodes.find((n2) => n2.id === highlightId) || null;
    }, [highlightId, graphData.nodes]);
    const dismissGuide = (0, import_react2.useCallback)(() => {
      setGuideOpen(false);
      try {
    ...
    const hint = (0, import_react2.useMemo)(() => {
      ...
      return `${nodeCount} \u4E2A\u601D\u8003 \xB7 ${linkCount} \u6761\u5173\u8054 \xB7 \u70B9\u51FB\u8282\u70B9\u53EF\u5728\u601D\u7EF4\u82B1\u56ED\u67E5\u770B`;
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-stage", ref: containerRef, children: [
      status === "ready" && guideOpen && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", { className: "cosmos-guide", "aria-label": "\u4F7F\u7528\u8BF4\u660E", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-guide-title", children: "\u8FD9\u662F\u4F60\u7684\u601D\u8003\u5173\u7CFB\u56FE" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("ul", { className: "cosmos-guide-list", children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "\u5706\u70B9" }),
            " = \u4E00\u6761\u601D\u8003\uFF0C",
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "\u8FDE\u7EBF" }),
            " = \u610F\u601D\u76F8\u8FD1\u6216\u5173\u952E\u8BCD\u76F8\u5173"
          ] }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("li", { children: "\u62D6\u52A8\u753B\u5E03\u5E73\u79FB\uFF0C\u6EDA\u8F6E\u7F29\u653E\uFF0C\u60AC\u505C\u770B\u6458\u8981" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("strong", { children: "\u70B9\u51FB\u8282\u70B9" }),
            " \u9009\u4E2D\uFF0C\u518D\u70B9\u300C\u5728\u601D\u7EF4\u82B1\u56ED\u4E2D\u67E5\u770B\u300D\u6253\u5F00\u7B14\u8BB0"
          ] })
        ] }),
      ...
      status === "ready" && selectedNode && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("aside", { className: "cosmos-selection", "aria-label": "\u5DF2\u9009\u601D\u8003", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-selection-label", children: "\u5DF2\u9009\u4E2D" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-selection-title", children: selectedNode.label || selectedNode.name || "\uFF08\u672A\u547D\u540D\u601D\u8003\uFF09" }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { className: "cosmos-selection-meta", children: [
          selectedNode.cluster || "\u672A\u5206\u4E3B\u9898",
          " \xB7 \u5173\u8054 ",
          selectedNode.degree || 0,
          selectedNode.createdAt ? ` \xB7 ${formatNodeDate(selectedNode.createdAt)}` : ""
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
      ...
      status === "ready" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        ForceGraph2D,
        {
          ...
          nodeRelSize: 1,
          nodeVal: "val",
          nodeLabel: (n2) => `${n2.label || n2.name}
${n2.cluster || ""} \xB7 \u5173\u8054 ${n2.degree || 0}`,
          nodeCanvasObject: paintNode,
          nodePointerAreaPaint: (node, color2, ctx) => {
            if (!isNodePlaced(node)) {
              return;
            }
            const r2 = nodeRadius(node) * 1.4;
            ctx.beginPath();
            ctx.arc(node.x, node.y, r2, 0, 2 * Math.PI, false);
      ...
      (status === "loading" || status === "empty" || status === "error") && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-overlay", "aria-live": "polite", children: [
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-overlay-text", children: hint })
      ] }),
      status === "ready" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-hint-bar", "aria-live": "polite", children: hint })
    ] });
  }
  function App() {
    return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-app", children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("header", { className: "cosmos-header", children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "cosmos-header-inner", children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", { className: "cosmos-title", children: "\u601D\u7EF4\u5B87\u5B99" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "cosmos-sub", children: "\u770B\u89C1\u60F3\u6CD5\u4E4B\u95F4\u7684\u5173\u8054 \xB7 \u70B9\u51FB\u8282\u70B9\u56DE\u5230\u601D\u7EF4\u82B1\u56ED" })
        ] }),
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("nav", { className: "cosmos-nav", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", { href: "dashboard.html", className: "cosmos-link", children: "\u2190 \u601D\u7EF4\u82B1\u56ED" }) })
      ] }) }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", { className: "cosmos-main", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CosmosGraph, {}) })
    ] });
  }
  ...
  if (rootEl) {
    try {
      ...
      rootEl.innerHTML = '<div class="cosmos-overlay" style="position:fixed;inset:0;display:flex;align-items:center;justify-content:center;padding:24px;text-align:center;color:#c8d4f0;background:#050816"><p>\u601D\u7EF4\u5B87\u5B99\u542F\u52A8\u5931\u8D25\uFF0C\u8BF7\u5728 chrome://extensions \u91CD\u65B0\u52A0\u8F7D MindTrace \u540E\u91CD\u8BD5\u3002</p></div>';
    }
  }
})();
